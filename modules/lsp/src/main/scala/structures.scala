...
object SemanticTokensRegistrationOptions:
  private given rd1: Reader[(Boolean | SemanticTokensRegistrationOptions.S0)] =
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | SemanticTokensRegistrationOptions.S0)],
      SemanticTokensRegistrationOptions.S0.reader
        .widen[(Boolean | SemanticTokensRegistrationOptions.S0)]
    )
  private given wt1: Writer[(Boolean | SemanticTokensRegistrationOptions.S0)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | SemanticTokensRegistrationOptions.S0)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: SemanticTokensRegistrationOptions.S0 =>
            writeJs[SemanticTokensRegistrationOptions.S0](v)
      }
  private given rd2: Reader[(Boolean | SemanticTokensRegistrationOptions.S1)] =
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | SemanticTokensRegistrationOptions.S1)],
      SemanticTokensRegistrationOptions.S1.reader
        .widen[(Boolean | SemanticTokensRegistrationOptions.S1)]
    )
  private given wt2: Writer[(Boolean | SemanticTokensRegistrationOptions.S1)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | SemanticTokensRegistrationOptions.S1)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: SemanticTokensRegistrationOptions.S1 =>
            writeJs[SemanticTokensRegistrationOptions.S1](v)
      }
  ...
  object S0:
    given reader: Reader[structures.SemanticTokensRegistrationOptions.S0] =
      Pickle.macroR
    given writer: Writer[structures.SemanticTokensRegistrationOptions.S0] =
      upickle.default.macroW
  case class S1(
      delta: Opt[Boolean] = Opt.empty
  )
  object S1:
    given reader: Reader[structures.SemanticTokensRegistrationOptions.S1] =
      Pickle.macroR
    given writer: Writer[structures.SemanticTokensRegistrationOptions.S1] =
      upickle.default.macroW
...
case class WorkspaceEdit(
    changes: Opt[Map[RuntimeBase.DocumentUri, Vector[structures.TextEdit]]] =
      Opt.empty,
    documentChanges: Opt[Vector[
      (structures.TextDocumentEdit | structures.CreateFile |
        structures.RenameFile | structures.DeleteFile)
    ]] = Opt.empty,
    changeAnnotations: Opt[
...
object WorkspaceEdit:
  private given rd0: Reader[
    ...
    structures.TextDocumentEdit.reader.widen[
      (structures.TextDocumentEdit | structures.CreateFile |
        structures.RenameFile | structures.DeleteFile)
    ],
    structures.CreateFile.reader.widen[
      (structures.TextDocumentEdit | structures.CreateFile |
        structures.RenameFile | structures.DeleteFile)
    ],
    structures.RenameFile.reader.widen[
      (structures.TextDocumentEdit | structures.CreateFile |
        structures.RenameFile | structures.DeleteFile)
    ],
    structures.DeleteFile.reader.widen[
      (structures.TextDocumentEdit | structures.CreateFile |
        structures.RenameFile | structures.DeleteFile)
    ]
  )
...
object InlayHint:
  private given rd0: Reader[(String | Vector[structures.InlayHintLabelPart])] =
    badMerge(
      stringCodec.widen[(String | Vector[structures.InlayHintLabelPart])],
      upickle.default
        .reader[Vector[structures.InlayHintLabelPart]]
        .widen[(String | Vector[structures.InlayHintLabelPart])]
    )
  ...
  private given rd1: Reader[(String | structures.MarkupContent)] = badMerge(
    stringCodec.widen[(String | structures.MarkupContent)],
    structures.MarkupContent.reader.widen[(String | structures.MarkupContent)]
  )
...
object DocumentDiagnosticReportPartialResult:
  private given rd0: Reader[
    ...
    structures.FullDocumentDiagnosticReport.reader.widen[
      (structures.FullDocumentDiagnosticReport |
        structures.UnchangedDocumentDiagnosticReport)
    ],
    structures.UnchangedDocumentDiagnosticReport.reader.widen[
      (structures.FullDocumentDiagnosticReport |
        structures.UnchangedDocumentDiagnosticReport)
    ]
  )
  ...
  given writer: Writer[structures.DocumentDiagnosticReportPartialResult] =
    upickle.default.macroW
end DocumentDiagnosticReportPartialResult
...
case class InitializeParams(
    ...
    workspaceFolders: Opt[Nullable[Vector[structures.WorkspaceFolder]]] =
      Opt.empty
)
object InitializeParams:
  private given rd3: Reader[("off" | "messages" | "compact" | "verbose")] =
    badMerge(
      upickle.default
        .reader["off"]
        .widen[("off" | "messages" | "compact" | "verbose")],
      upickle.default
        .reader["messages"]
        .widen[("off" | "messages" | "compact" | "verbose")],
      upickle.default
  ...
  private given wt3: Writer[("off" | "messages" | "compact" | "verbose")] =
    upickle.default
      .writer[ujson.Value]
      .comap[("off" | "messages" | "compact" | "verbose")] { _v =>
        (_v: @unchecked) match
...
object DidChangeConfigurationRegistrationOptions:
  private given rd0: Reader[(String | Vector[String])] = badMerge(
    stringCodec.widen[(String | Vector[String])],
    upickle.default.reader[Vector[String]].widen[(String | Vector[String])]
  )
  ...
  given writer: Writer[structures.DidChangeConfigurationRegistrationOptions] =
    upickle.default.macroW
end DidChangeConfigurationRegistrationOptions
...
case class CompletionItem(
    ...
    textEdit: Opt[(structures.TextEdit | structures.InsertReplaceEdit)] =
      Opt.empty,
...
object CompletionItem:
  private given rd0: Reader[(String | structures.MarkupContent)] = badMerge(
    stringCodec.widen[(String | structures.MarkupContent)],
    structures.MarkupContent.reader.widen[(String | structures.MarkupContent)]
  )
  ...
  private given rd1
      : Reader[(structures.TextEdit | structures.InsertReplaceEdit)] = badMerge(
    structures.TextEdit.reader
      .widen[(structures.TextEdit | structures.InsertReplaceEdit)],
...
object CompletionList:
  ...
  object ItemDefaults:
    private given rd0: Reader[(structures.Range | ItemDefaults.S0)] = badMerge(
      structures.Range.reader.widen[(structures.Range | ItemDefaults.S0)],
      ItemDefaults.S0.reader.widen[(structures.Range | ItemDefaults.S0)]
    )
    private given wt0: Writer[(structures.Range | ItemDefaults.S0)] =
      upickle.default
        .writer[ujson.Value]
        .comap[(structures.Range | ItemDefaults.S0)] { _v =>
          (_v: @unchecked) match
    ...
    object S0:
      given reader: Reader[structures.CompletionList.ItemDefaults.S0] =
        Pickle.macroR
      given writer: Writer[structures.CompletionList.ItemDefaults.S0] =
        upickle.default.macroW
  end ItemDefaults
end CompletionList
...
case class CompletionRegistrationOptions(
    ...
    resolveProvider: Opt[Boolean] = Opt.empty,
    completionItem: Opt[CompletionRegistrationOptions.CompletionItem] =
      Opt.empty
)
...
object Hover:
  private given rd0: Reader[
    ...
    structures.MarkupContent.reader.widen[
      (structures.MarkupContent | aliases.MarkedString |
        Vector[aliases.MarkedString])
    ],
    aliases.MarkedString.reader.widen[
      (structures.MarkupContent | aliases.MarkedString |
        Vector[aliases.MarkedString])
    ],
    upickle.default
      .reader[Vector[aliases.MarkedString]]
      .widen[
        (structures.MarkupContent | aliases.MarkedString |
          Vector[aliases.MarkedString])
      ]
...
object CodeAction:
  ...
  object Disabled:
    ...
    given writer: Writer[structures.CodeAction.Disabled] =
      upickle.default.macroW
end CodeAction
  ...
  private given rd0: Reader[(structures.Location | WorkspaceSymbol.S0)] =
    badMerge(
      structures.Location.reader
        .widen[(structures.Location | WorkspaceSymbol.S0)],
      WorkspaceSymbol.S0.reader
        .widen[(structures.Location | WorkspaceSymbol.S0)]
    )
  private given wt0: Writer[(structures.Location | WorkspaceSymbol.S0)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(structures.Location | WorkspaceSymbol.S0)] { _v =>
        (_v: @unchecked) match
...
object CancelParams:
  private given rd0: Reader[(Int | String)] =
    badMerge(intCodec.widen[(Int | String)], stringCodec.widen[(Int | String)])
...
object SemanticTokensOptions:
  private given rd0: Reader[(Boolean | SemanticTokensOptions.S0)] = badMerge(
    upickle.default.reader[Boolean].widen[(Boolean | SemanticTokensOptions.S0)],
    SemanticTokensOptions.S0.reader.widen[(Boolean | SemanticTokensOptions.S0)]
  )
  private given wt0: Writer[(Boolean | SemanticTokensOptions.S0)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | SemanticTokensOptions.S0)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: SemanticTokensOptions.S0 =>
            writeJs[SemanticTokensOptions.S0](v)
      }
  private given rd1: Reader[(Boolean | SemanticTokensOptions.S1)] = badMerge(
    upickle.default.reader[Boolean].widen[(Boolean | SemanticTokensOptions.S1)],
    SemanticTokensOptions.S1.reader.widen[(Boolean | SemanticTokensOptions.S1)]
  )
  private given wt1: Writer[(Boolean | SemanticTokensOptions.S1)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | SemanticTokensOptions.S1)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: SemanticTokensOptions.S1 =>
            writeJs[SemanticTokensOptions.S1](v)
      }
  ...
  object S0:
    ...
    given writer: Writer[structures.SemanticTokensOptions.S0] =
      upickle.default.macroW
  case class S1(
      delta: Opt[Boolean] = Opt.empty
  )
  object S1:
    ...
    given writer: Writer[structures.SemanticTokensOptions.S1] =
      upickle.default.macroW
...
object TextDocumentEdit:
  private given rd0
      : Reader[(structures.TextEdit | structures.AnnotatedTextEdit)] = badMerge(
    structures.TextEdit.reader
      .widen[(structures.TextEdit | structures.AnnotatedTextEdit)],
...
object RelatedFullDocumentDiagnosticReport:
  ...
  given writer: Writer[structures.RelatedFullDocumentDiagnosticReport] =
    upickle.default.macroW
end RelatedFullDocumentDiagnosticReport
...
object RelatedUnchangedDocumentDiagnosticReport:
  ...
  given writer: Writer[structures.RelatedUnchangedDocumentDiagnosticReport] =
    upickle.default.macroW
end RelatedUnchangedDocumentDiagnosticReport
...
object NotebookDocumentChangeEvent:
  ...
  object Cells:
    ...
    object Structure:
      given reader
          : Reader[structures.NotebookDocumentChangeEvent.Cells.Structure] =
        Pickle.macroR
      given writer
          : Writer[structures.NotebookDocumentChangeEvent.Cells.Structure] =
        upickle.default.macroW
    case class S0(
    ...
    object S0:
      given reader: Reader[structures.NotebookDocumentChangeEvent.Cells.S0] =
        Pickle.macroR
      given writer: Writer[structures.NotebookDocumentChangeEvent.Cells.S0] =
        upickle.default.macroW
  end Cells
...
object _InitializeParams:
  ...
  object ClientInfo:
    given reader: Reader[structures._InitializeParams.ClientInfo] =
      Pickle.macroR
...
case class ServerCapabilities(
    ...
    declarationProvider: Opt[
      (Boolean | structures.DeclarationOptions |
        structures.DeclarationRegistrationOptions)
    ] = Opt.empty,
    definitionProvider: Opt[(Boolean | structures.DefinitionOptions)] =
      Opt.empty,
    typeDefinitionProvider: Opt[
      (Boolean | structures.TypeDefinitionOptions |
        structures.TypeDefinitionRegistrationOptions)
    ] = Opt.empty,
    implementationProvider: Opt[
      (Boolean | structures.ImplementationOptions |
        structures.ImplementationRegistrationOptions)
    ] = Opt.empty,
    referencesProvider: Opt[(Boolean | structures.ReferenceOptions)] =
      Opt.empty,
    documentHighlightProvider: Opt[
      (Boolean | structures.DocumentHighlightOptions)
    ] = Opt.empty,
    documentSymbolProvider: Opt[(Boolean | structures.DocumentSymbolOptions)] =
      Opt.empty,
    codeActionProvider: Opt[(Boolean | structures.CodeActionOptions)] =
      Opt.empty,
...
object ServerCapabilities:
  private given rd0: Reader[
    ...
    structures.TextDocumentSyncOptions.reader.widen[
      (structures.TextDocumentSyncOptions | enumerations.TextDocumentSyncKind)
    ],
    enumerations.TextDocumentSyncKind.reader.widen[
      (structures.TextDocumentSyncOptions | enumerations.TextDocumentSyncKind)
    ]
  )
  private given wt0: Writer[
  ...
  private given rd1: Reader[
    ...
    structures.NotebookDocumentSyncOptions.reader.widen[
      (structures.NotebookDocumentSyncOptions |
        structures.NotebookDocumentSyncRegistrationOptions)
    ],
    structures.NotebookDocumentSyncRegistrationOptions.reader.widen[
      (structures.NotebookDocumentSyncOptions |
        structures.NotebookDocumentSyncRegistrationOptions)
    ]
  )
  ...
  private given rd2: Reader[(Boolean | structures.HoverOptions)] = badMerge(
    upickle.default.reader[Boolean].widen[(Boolean | structures.HoverOptions)],
    structures.HoverOptions.reader.widen[(Boolean | structures.HoverOptions)]
  )
  ...
  private given rd3: Reader[
    ...
    structures.DeclarationOptions.reader.widen[
      (Boolean | structures.DeclarationOptions |
        structures.DeclarationRegistrationOptions)
    ],
    structures.DeclarationRegistrationOptions.reader.widen[
      (Boolean | structures.DeclarationOptions |
        structures.DeclarationRegistrationOptions)
    ]
  )
  ...
  private given rd4: Reader[(Boolean | structures.DefinitionOptions)] =
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | structures.DefinitionOptions)],
  ...
  private given rd5: Reader[
    ...
    structures.TypeDefinitionOptions.reader.widen[
      (Boolean | structures.TypeDefinitionOptions |
        structures.TypeDefinitionRegistrationOptions)
    ],
    structures.TypeDefinitionRegistrationOptions.reader.widen[
      (Boolean | structures.TypeDefinitionOptions |
        structures.TypeDefinitionRegistrationOptions)
    ]
  )
  ...
  private given rd6: Reader[
    ...
    structures.ImplementationOptions.reader.widen[
      (Boolean | structures.ImplementationOptions |
        structures.ImplementationRegistrationOptions)
    ],
    structures.ImplementationRegistrationOptions.reader.widen[
      (Boolean | structures.ImplementationOptions |
        structures.ImplementationRegistrationOptions)
    ]
  )
  ...
  private given rd7: Reader[(Boolean | structures.ReferenceOptions)] = badMerge(
    upickle.default
      .reader[Boolean]
      .widen[(Boolean | structures.ReferenceOptions)],
  ...
  private given rd8: Reader[(Boolean | structures.DocumentHighlightOptions)] =
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | structures.DocumentHighlightOptions)],
  ...
  private given rd9: Reader[(Boolean | structures.DocumentSymbolOptions)] =
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | structures.DocumentSymbolOptions)],
  ...
  private given rd10: Reader[(Boolean | structures.CodeActionOptions)] =
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | structures.CodeActionOptions)],
  ...
  private given rd11: Reader[
    ...
    structures.DocumentColorOptions.reader.widen[
      (Boolean | structures.DocumentColorOptions |
        structures.DocumentColorRegistrationOptions)
    ],
    structures.DocumentColorRegistrationOptions.reader.widen[
      (Boolean | structures.DocumentColorOptions |
        structures.DocumentColorRegistrationOptions)
    ]
  )
  ...
  private given rd12: Reader[(Boolean | structures.WorkspaceSymbolOptions)] =
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | structures.WorkspaceSymbolOptions)],
  ...
  private given rd13: Reader[(Boolean | structures.DocumentFormattingOptions)] =
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | structures.DocumentFormattingOptions)],
  ...
  private given rd14
    ...
    badMerge(
      upickle.default
        .reader[Boolean]
        .widen[(Boolean | structures.DocumentRangeFormattingOptions)],
  ...
  private given rd15: Reader[(Boolean | structures.RenameOptions)] = badMerge(
    upickle.default.reader[Boolean].widen[(Boolean | structures.RenameOptions)],
    structures.RenameOptions.reader.widen[(Boolean | structures.RenameOptions)]
  )
  ...
  private given rd16: Reader[
    ...
    structures.FoldingRangeOptions.reader.widen[
      (Boolean | structures.FoldingRangeOptions |
        structures.FoldingRangeRegistrationOptions)
    ],
    structures.FoldingRangeRegistrationOptions.reader.widen[
      (Boolean | structures.FoldingRangeOptions |
        structures.FoldingRangeRegistrationOptions)
    ]
  )
  ...
  private given rd17: Reader[
    ...
    structures.SelectionRangeOptions.reader.widen[
      (Boolean | structures.SelectionRangeOptions |
        structures.SelectionRangeRegistrationOptions)
    ],
    structures.SelectionRangeRegistrationOptions.reader.widen[
      (Boolean | structures.SelectionRangeOptions |
        structures.SelectionRangeRegistrationOptions)
    ]
  )
  ...
  private given rd18: Reader[
    ...
    structures.CallHierarchyOptions.reader.widen[
      (Boolean | structures.CallHierarchyOptions |
        structures.CallHierarchyRegistrationOptions)
    ],
    structures.CallHierarchyRegistrationOptions.reader.widen[
      (Boolean | structures.CallHierarchyOptions |
        structures.CallHierarchyRegistrationOptions)
    ]
  )
  ...
  private given rd19: Reader[
    ...
    structures.LinkedEditingRangeOptions.reader.widen[
      (Boolean | structures.LinkedEditingRangeOptions |
        structures.LinkedEditingRangeRegistrationOptions)
    ],
    structures.LinkedEditingRangeRegistrationOptions.reader.widen[
      (Boolean | structures.LinkedEditingRangeOptions |
        structures.LinkedEditingRangeRegistrationOptions)
    ]
  )
  ...
  private given rd20: Reader[
    ...
    structures.SemanticTokensOptions.reader.widen[
      (structures.SemanticTokensOptions |
        structures.SemanticTokensRegistrationOptions)
    ],
    structures.SemanticTokensRegistrationOptions.reader.widen[
      (structures.SemanticTokensOptions |
        structures.SemanticTokensRegistrationOptions)
    ]
  )
  ...
  private given rd21: Reader[
    ...
    structures.MonikerOptions.reader.widen[
      (Boolean | structures.MonikerOptions |
        structures.MonikerRegistrationOptions)
    ],
    structures.MonikerRegistrationOptions.reader.widen[
      (Boolean | structures.MonikerOptions |
        structures.MonikerRegistrationOptions)
    ]
  )
  ...
  private given rd22: Reader[
    ...
    structures.TypeHierarchyOptions.reader.widen[
      (Boolean | structures.TypeHierarchyOptions |
        structures.TypeHierarchyRegistrationOptions)
    ],
    structures.TypeHierarchyRegistrationOptions.reader.widen[
      (Boolean | structures.TypeHierarchyOptions |
        structures.TypeHierarchyRegistrationOptions)
    ]
  )
  ...
  private given rd23: Reader[
    ...
    structures.InlineValueOptions.reader.widen[
      (Boolean | structures.InlineValueOptions |
        structures.InlineValueRegistrationOptions)
    ],
    structures.InlineValueRegistrationOptions.reader.widen[
      (Boolean | structures.InlineValueOptions |
        structures.InlineValueRegistrationOptions)
    ]
  )
  ...
  private given rd24: Reader[
    ...
    structures.InlayHintOptions.reader.widen[
      (Boolean | structures.InlayHintOptions |
        structures.InlayHintRegistrationOptions)
    ],
    structures.InlayHintRegistrationOptions.reader.widen[
      (Boolean | structures.InlayHintOptions |
        structures.InlayHintRegistrationOptions)
    ]
  )
  ...
  private given rd25: Reader[
    ...
    structures.DiagnosticOptions.reader.widen[
      (structures.DiagnosticOptions | structures.DiagnosticRegistrationOptions)
    ],
    structures.DiagnosticRegistrationOptions.reader.widen[
      (structures.DiagnosticOptions | structures.DiagnosticRegistrationOptions)
    ]
  )
  ...
  case class Workspace(
      workspaceFolders: Opt[structures.WorkspaceFoldersServerCapabilities] =
        Opt.empty,
      fileOperations: Opt[structures.FileOperationOptions] = Opt.empty
  )
  object Workspace:
    given reader: Reader[structures.ServerCapabilities.Workspace] =
      Pickle.macroR
...
case class Diagnostic(
    ...
    relatedInformation: Opt[Vector[structures.DiagnosticRelatedInformation]] =
      Opt.empty,
    data: Opt[ujson.Value] = Opt.empty
)
object Diagnostic:
...
case class ClientCapabilities(
    ...
    notebookDocument: Opt[structures.NotebookDocumentClientCapabilities] =
      Opt.empty,
...
object TextDocumentSyncOptions:
  private given rd0: Reader[(Boolean | structures.SaveOptions)] = badMerge(
    upickle.default.reader[Boolean].widen[(Boolean | structures.SaveOptions)],
    structures.SaveOptions.reader.widen[(Boolean | structures.SaveOptions)]
  )
...
object NotebookDocumentSyncOptions:
  private given rd0: Reader[
    ...
    NotebookDocumentSyncOptions.S0.reader
      .widen[(NotebookDocumentSyncOptions.S0 | NotebookDocumentSyncOptions.S1)],
    NotebookDocumentSyncOptions.S1.reader
      .widen[(NotebookDocumentSyncOptions.S0 | NotebookDocumentSyncOptions.S1)]
  )
  private given wt0: Writer[
    (NotebookDocumentSyncOptions.S0 | NotebookDocumentSyncOptions.S1)
    ...
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: NotebookDocumentSyncOptions.S0 =>
            writeJs[NotebookDocumentSyncOptions.S0](v)
          case v: NotebookDocumentSyncOptions.S1 =>
            writeJs[NotebookDocumentSyncOptions.S1](v)
      }
  ...
  object S0:
    private given rd0: Reader[(String | aliases.NotebookDocumentFilter)] =
      badMerge(
        stringCodec.widen[(String | aliases.NotebookDocumentFilter)],
        aliases.NotebookDocumentFilter.reader
          .widen[(String | aliases.NotebookDocumentFilter)]
      )
    ...
    given reader: Reader[structures.NotebookDocumentSyncOptions.S0] =
      Pickle.macroR
    given writer: Writer[structures.NotebookDocumentSyncOptions.S0] =
      upickle.default.macroW
    case class S0(
        language: String
    )
    object S0:
      given reader: Reader[structures.NotebookDocumentSyncOptions.S0.S0] =
        Pickle.macroR
      given writer: Writer[structures.NotebookDocumentSyncOptions.S0.S0] =
        upickle.default.macroW
  end S0
  case class S1(
  ...
  object S1:
    ...
    given reader: Reader[structures.NotebookDocumentSyncOptions.S1] =
      Pickle.macroR
    given writer: Writer[structures.NotebookDocumentSyncOptions.S1] =
      upickle.default.macroW
    case class S0(
        language: String
    )
    object S0:
      given reader: Reader[structures.NotebookDocumentSyncOptions.S1.S0] =
        Pickle.macroR
      given writer: Writer[structures.NotebookDocumentSyncOptions.S1.S0] =
        upickle.default.macroW
  end S1
...
object NotebookDocumentSyncRegistrationOptions:
  private given rd0: Reader[
    ...
    NotebookDocumentSyncRegistrationOptions.S0.reader.widen[
      (NotebookDocumentSyncRegistrationOptions.S0 |
        NotebookDocumentSyncRegistrationOptions.S1)
    ],
    NotebookDocumentSyncRegistrationOptions.S1.reader.widen[
      (NotebookDocumentSyncRegistrationOptions.S0 |
        NotebookDocumentSyncRegistrationOptions.S1)
    ]
  )
  private given wt0: Writer[
    ...
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: NotebookDocumentSyncRegistrationOptions.S0 =>
            writeJs[NotebookDocumentSyncRegistrationOptions.S0](v)
          case v: NotebookDocumentSyncRegistrationOptions.S1 =>
            writeJs[NotebookDocumentSyncRegistrationOptions.S1](v)
      }
  ...
  object S0:
    ...
    given reader
        : Reader[structures.NotebookDocumentSyncRegistrationOptions.S0] =
      Pickle.macroR
    given writer
        : Writer[structures.NotebookDocumentSyncRegistrationOptions.S0] =
      upickle.default.macroW
    case class S0(
        language: String
    )
    object S0:
      given reader
          : Reader[structures.NotebookDocumentSyncRegistrationOptions.S0.S0] =
        Pickle.macroR
      given writer
          : Writer[structures.NotebookDocumentSyncRegistrationOptions.S0.S0] =
        upickle.default.macroW
  end S0
  case class S1(
      notebook: Opt[(String | aliases.NotebookDocumentFilter)] = Opt.empty,
  ...
  object S1:
    ...
    given reader
        : Reader[structures.NotebookDocumentSyncRegistrationOptions.S1] =
      Pickle.macroR
    given writer
        : Writer[structures.NotebookDocumentSyncRegistrationOptions.S1] =
      upickle.default.macroW
    case class S0(
        language: String
    )
    object S0:
      given reader
          : Reader[structures.NotebookDocumentSyncRegistrationOptions.S1.S0] =
        Pickle.macroR
      given writer
          : Writer[structures.NotebookDocumentSyncRegistrationOptions.S1.S0] =
        upickle.default.macroW
  end S1
...
object WorkspaceFoldersServerCapabilities:
  private given rd0: Reader[(String | Boolean)] = badMerge(
    stringCodec.widen[(String | Boolean)],
    upickle.default.reader[Boolean].widen[(String | Boolean)]
  )
  ...
  given writer: Writer[structures.WorkspaceFoldersServerCapabilities] =
    upickle.default.macroW
end WorkspaceFoldersServerCapabilities
...
object ParameterInformation:
  private given rd0
      : Reader[(String | (RuntimeBase.uinteger, RuntimeBase.uinteger))] =
    badMerge(
      stringCodec
        .widen[(String | (RuntimeBase.uinteger, RuntimeBase.uinteger))],
      upickle.default
        .reader[(RuntimeBase.uinteger, RuntimeBase.uinteger)]
        .widen[(String | (RuntimeBase.uinteger, RuntimeBase.uinteger))]
    )
  private given wt0
      : Writer[(String | (RuntimeBase.uinteger, RuntimeBase.uinteger))] =
    upickle.default
      .writer[ujson.Value]
      .comap[(String | (RuntimeBase.uinteger, RuntimeBase.uinteger))] { _v =>
        (_v: @unchecked) match
          case v: String => writeJs[String](v)
          case v: (RuntimeBase.uinteger, RuntimeBase.uinteger) =>
            writeJs[(RuntimeBase.uinteger, RuntimeBase.uinteger)](v)
      }
  private given rd1: Reader[(String | structures.MarkupContent)] = badMerge(
    stringCodec.widen[(String | structures.MarkupContent)],
    structures.MarkupContent.reader.widen[(String | structures.MarkupContent)]
...
object NotebookCellTextDocumentFilter:
  ...
  given writer: Writer[structures.NotebookCellTextDocumentFilter] =
    upickle.default.macroW
end NotebookCellTextDocumentFilter
...
case class WorkspaceClientCapabilities(
    ...
    inlineValue: Opt[structures.InlineValueWorkspaceClientCapabilities] =
      Opt.empty,
    inlayHint: Opt[structures.InlayHintWorkspaceClientCapabilities] = Opt.empty,
    diagnostics: Opt[structures.DiagnosticWorkspaceClientCapabilities] =
      Opt.empty
)
...
case class TextDocumentClientCapabilities(
    synchronization: Opt[structures.TextDocumentSyncClientCapabilities] =
      Opt.empty,
    ...
    typeDefinition: Opt[structures.TypeDefinitionClientCapabilities] =
      Opt.empty,
    implementation: Opt[structures.ImplementationClientCapabilities] =
      Opt.empty,
    references: Opt[structures.ReferenceClientCapabilities] = Opt.empty,
    documentHighlight: Opt[structures.DocumentHighlightClientCapabilities] =
      Opt.empty,
    documentSymbol: Opt[structures.DocumentSymbolClientCapabilities] =
      Opt.empty,
    ...
    formatting: Opt[structures.DocumentFormattingClientCapabilities] =
      Opt.empty,
    rangeFormatting: Opt[structures.DocumentRangeFormattingClientCapabilities] =
      Opt.empty,
    onTypeFormatting: Opt[
    ...
    selectionRange: Opt[structures.SelectionRangeClientCapabilities] =
      Opt.empty,
    publishDiagnostics: Opt[structures.PublishDiagnosticsClientCapabilities] =
      Opt.empty,
    callHierarchy: Opt[structures.CallHierarchyClientCapabilities] = Opt.empty,
    semanticTokens: Opt[structures.SemanticTokensClientCapabilities] =
      Opt.empty,
    linkedEditingRange: Opt[structures.LinkedEditingRangeClientCapabilities] =
      Opt.empty,
...
case class WindowClientCapabilities(
    workDoneProgress: Opt[Boolean] = Opt.empty,
    showMessage: Opt[structures.ShowMessageRequestClientCapabilities] =
      Opt.empty,
...
case class GeneralClientCapabilities(
    staleRequestSupport: Opt[GeneralClientCapabilities.StaleRequestSupport] =
      Opt.empty,
    regularExpressions: Opt[structures.RegularExpressionsClientCapabilities] =
      Opt.empty,
    markdown: Opt[structures.MarkdownClientCapabilities] = Opt.empty,
    positionEncodings: Opt[Vector[enumerations.PositionEncodingKind]] =
      Opt.empty
)
  ...
  private given rd0: Reader[(structures.WorkspaceFolder | aliases.URI)] =
    badMerge(
      structures.WorkspaceFolder.reader
        .widen[(structures.WorkspaceFolder | aliases.URI)],
      aliases.URI.reader.widen[(structures.WorkspaceFolder | aliases.URI)]
    )
  private given wt0: Writer[(structures.WorkspaceFolder | aliases.URI)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(structures.WorkspaceFolder | aliases.URI)] { _v =>
        (_v: @unchecked) match
...
case class WorkspaceSymbolClientCapabilities(
    ...
    resolveSupport: Opt[WorkspaceSymbolClientCapabilities.ResolveSupport] =
      Opt.empty
)
...
case class CompletionClientCapabilities(
    dynamicRegistration: Opt[Boolean] = Opt.empty,
    completionItem: Opt[CompletionClientCapabilities.CompletionItem] =
      Opt.empty,
    completionItemKind: Opt[CompletionClientCapabilities.CompletionItemKind] =
      Opt.empty,
    insertTextMode: Opt[enumerations.InsertTextMode] = Opt.empty,
...
object CompletionClientCapabilities:
  ...
  case class CompletionItem(
      ...
      insertTextModeSupport: Opt[CompletionItem.InsertTextModeSupport] =
        Opt.empty,
      labelDetailsSupport: Opt[Boolean] = Opt.empty
  )
  object CompletionItem:
    given reader
        : Reader[structures.CompletionClientCapabilities.CompletionItem] =
      Pickle.macroR
    given writer
        : Writer[structures.CompletionClientCapabilities.CompletionItem] =
      upickle.default.macroW
    case class TagSupport(
  ...
  object CompletionList:
    given reader
        : Reader[structures.CompletionClientCapabilities.CompletionList] =
      Pickle.macroR
    given writer
        : Writer[structures.CompletionClientCapabilities.CompletionList] =
      upickle.default.macroW
...
object SignatureHelpClientCapabilities:
  ...
  case class SignatureInformation(
      documentationFormat: Opt[Vector[enumerations.MarkupKind]] = Opt.empty,
      parameterInformation: Opt[SignatureInformation.ParameterInformation] =
        Opt.empty,
...
object DocumentSymbolClientCapabilities:
  ...
  object SymbolKind:
    given reader
        : Reader[structures.DocumentSymbolClientCapabilities.SymbolKind] =
      Pickle.macroR
    given writer
        : Writer[structures.DocumentSymbolClientCapabilities.SymbolKind] =
      upickle.default.macroW
  case class TagSupport(
      valueSet: Vector[enumerations.SymbolTag]
  )
  object TagSupport:
    given reader
        : Reader[structures.DocumentSymbolClientCapabilities.TagSupport] =
      Pickle.macroR
    given writer
        : Writer[structures.DocumentSymbolClientCapabilities.TagSupport] =
      upickle.default.macroW
...
case class CodeActionClientCapabilities(
    ...
    resolveSupport: Opt[CodeActionClientCapabilities.ResolveSupport] =
      Opt.empty,
...
object CodeActionClientCapabilities:
  ...
  object ResolveSupport:
    given reader
        : Reader[structures.CodeActionClientCapabilities.ResolveSupport] =
      Pickle.macroR
    given writer
        : Writer[structures.CodeActionClientCapabilities.ResolveSupport] =
      upickle.default.macroW
...
case class RenameClientCapabilities(
    ...
    prepareSupportDefaultBehavior: Opt[
...
case class FoldingRangeClientCapabilities(
    ...
    foldingRangeKind: Opt[FoldingRangeClientCapabilities.FoldingRangeKind] =
      Opt.empty,
...
object FoldingRangeClientCapabilities:
  ...
  object FoldingRange:
    given reader
        : Reader[structures.FoldingRangeClientCapabilities.FoldingRange] =
      Pickle.macroR
    given writer
        : Writer[structures.FoldingRangeClientCapabilities.FoldingRange] =
      upickle.default.macroW
...
case class PublishDiagnosticsClientCapabilities(
    ...
    tagSupport: Opt[PublishDiagnosticsClientCapabilities.TagSupport] =
      Opt.empty,
...
object SemanticTokensClientCapabilities:
  ...
  object Requests:
    private given rd0: Reader[(Boolean | Requests.S0)] = badMerge(
      upickle.default.reader[Boolean].widen[(Boolean | Requests.S0)],
      Requests.S0.reader.widen[(Boolean | Requests.S0)]
    )
    ...
    private given rd1: Reader[(Boolean | Requests.S1)] = badMerge(
      upickle.default.reader[Boolean].widen[(Boolean | Requests.S1)],
      Requests.S1.reader.widen[(Boolean | Requests.S1)]
    )
    ...
    object S0:
      given reader
          : Reader[structures.SemanticTokensClientCapabilities.Requests.S0] =
        Pickle.macroR
      given writer
          : Writer[structures.SemanticTokensClientCapabilities.Requests.S0] =
        upickle.default.macroW
    case class S1(
        delta: Opt[Boolean] = Opt.empty
    )
    object S1:
      given reader
          : Reader[structures.SemanticTokensClientCapabilities.Requests.S1] =
        Pickle.macroR
      given writer
          : Writer[structures.SemanticTokensClientCapabilities.Requests.S1] =
        upickle.default.macroW
  end Requests
...
object InlayHintClientCapabilities:
  ...
  object ResolveSupport:
    given reader
        : Reader[structures.InlayHintClientCapabilities.ResolveSupport] =
      Pickle.macroR
    given writer
        : Writer[structures.InlayHintClientCapabilities.ResolveSupport] =
      upickle.default.macroW
