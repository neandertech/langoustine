...
private[lsp] trait requests_callHierarchy_incomingCalls:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.CallHierarchyIncomingCall]],
      nullReadWriter
    )
...
private[lsp] trait requests_callHierarchy_outgoingCalls:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.CallHierarchyOutgoingCall]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_codeAction:
      ...
      (_v: @unchecked) match
        case v: Vector[?] =>
          writeJs[Vector[(structures.Command | structures.CodeAction)]](
            v.asInstanceOf[Vector[(structures.Command | structures.CodeAction)]]
          )
        case a if a == Opt.empty => ujson.Null
    }
  end outputWriter
  ...
  given outputReader: Reader[Out] =
    given Reader[(structures.Command | structures.CodeAction)] =
      badMerge[(structures.Command | structures.CodeAction)](
        structures.Command.reader,
        structures.CodeAction.reader
      )
    badMerge[Out](
      upickle.default
        .reader[Vector[(structures.Command | structures.CodeAction)]],
      nullReadWriter
    )
  end outputReader
...
private[lsp] trait requests_textDocument_codeLens:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.CodeLens]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_completion:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.CompletionItem]],
      structures.CompletionList.reader,
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_declaration:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      aliases.Declaration.reader,
      upickle.default.reader[Vector[aliases.DeclarationLink]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_definition:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      aliases.Definition.reader,
      upickle.default.reader[Vector[aliases.DefinitionLink]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_documentHighlight:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.DocumentHighlight]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_documentLink:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.DocumentLink]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_documentSymbol:
      ...
      (_v: @unchecked) match
        case v: Vector[?] =>
          v.headOption match
            ...
            case Some(_: structures.SymbolInformation) =>
              writeJs[Vector[structures.SymbolInformation]](
                v.asInstanceOf[Vector[structures.SymbolInformation]]
              )
            case Some(_: structures.DocumentSymbol) =>
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.SymbolInformation]],
      upickle.default.reader[Vector[structures.DocumentSymbol]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_foldingRange:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.FoldingRange]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_formatting:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.TextEdit]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_inlayHint:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.InlayHint]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_inlineValue:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[aliases.InlineValue]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_moniker:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.Moniker]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_prepareCallHierarchy:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.CallHierarchyItem]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_prepareTypeHierarchy:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.TypeHierarchyItem]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_references:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.Location]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_selectionRange:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.SelectionRange]],
      nullReadWriter
    )
...
private[lsp] trait requests_textDocument_semanticTokens_full_delta:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      structures.SemanticTokens.reader,
      structures.SemanticTokensDelta.reader,
      nullReadWriter
    )
...
private[lsp] trait requests_workspace_symbol:
      ...
      (_v: @unchecked) match
        case v: Vector[?] =>
          v.headOption match
            ...
            case Some(_: structures.WorkspaceSymbol) =>
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.SymbolInformation]],
      upickle.default.reader[Vector[structures.WorkspaceSymbol]],
      nullReadWriter
    )
...
private[lsp] trait requests_workspace_workspaceFolders:
  ...
  given outputReader: Reader[Out] =
    badMerge[Out](
      upickle.default.reader[Vector[structures.WorkspaceFolder]],
      nullReadWriter
    )
...
private[lsp] trait structures_ApplyWorkspaceEditParamsCodec:
  ...
  given writer: Writer[structures.ApplyWorkspaceEditParams] =
...
private[lsp] trait structures_ApplyWorkspaceEditResultCodec:
  ...
  given writer: Writer[structures.ApplyWorkspaceEditResult] =
    upickle.default.macroW
...
private[lsp] trait structures_BaseSymbolInformationCodec:
  ...
  given writer: Writer[structures.BaseSymbolInformation] =
    upickle.default.macroW

private[lsp] trait structures_CallHierarchyClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.CallHierarchyClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.CallHierarchyClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_CallHierarchyIncomingCallCodec:
  ...
  given writer: Writer[structures.CallHierarchyIncomingCall] =
    upickle.default.macroW

private[lsp] trait structures_CallHierarchyIncomingCallsParamsCodec:
  import structures.*
  given reader: Reader[structures.CallHierarchyIncomingCallsParams] =
    Pickle.macroR
  given writer: Writer[structures.CallHierarchyIncomingCallsParams] =
    upickle.default.macroW
...
private[lsp] trait structures_CallHierarchyOutgoingCallCodec:
  ...
  given writer: Writer[structures.CallHierarchyOutgoingCall] =
    upickle.default.macroW

private[lsp] trait structures_CallHierarchyOutgoingCallsParamsCodec:
  import structures.*
  given reader: Reader[structures.CallHierarchyOutgoingCallsParams] =
    Pickle.macroR
  given writer: Writer[structures.CallHierarchyOutgoingCallsParams] =
    upickle.default.macroW
...
private[lsp] trait structures_CallHierarchyPrepareParamsCodec:
  ...
  given writer: Writer[structures.CallHierarchyPrepareParams] =
    upickle.default.macroW

private[lsp] trait structures_CallHierarchyRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.CallHierarchyRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.CallHierarchyRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_CodeActionClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.CodeActionClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_CodeActionClientCapabilities_CodeActionLiteralSupportCodec:
  ...
  given reader: Reader[
    structures.CodeActionClientCapabilities.CodeActionLiteralSupport
  ] = Pickle.macroR
  given writer: Writer[
    structures.CodeActionClientCapabilities.CodeActionLiteralSupport
  ] = upickle.default.macroW
...
private[lsp] trait structures_CodeActionClientCapabilities_CodeActionLiteralSupport_CodeActionKindCodec:
  ...
  given reader: Reader[
    structures.CodeActionClientCapabilities.CodeActionLiteralSupport.CodeActionKind
  ] = Pickle.macroR
  given writer: Writer[
    structures.CodeActionClientCapabilities.CodeActionLiteralSupport.CodeActionKind
  ] = upickle.default.macroW
...
private[lsp] trait structures_CodeActionClientCapabilities_ResolveSupportCodec:
  import structures.CodeActionClientCapabilities.*
  given reader: Reader[structures.CodeActionClientCapabilities.ResolveSupport] =
    Pickle.macroR
  given writer: Writer[structures.CodeActionClientCapabilities.ResolveSupport] =
    upickle.default.macroW
...
private[lsp] trait structures_CodeActionRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.CodeActionRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_CodeLensClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.CodeLensClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_CodeLensRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.CodeLensRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_CodeLensWorkspaceClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.CodeLensWorkspaceClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.CodeLensWorkspaceClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_ColorPresentationParamsCodec:
  ...
  given writer: Writer[structures.ColorPresentationParams] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.CompletionClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionClientCapabilities_CompletionItemCodec:
  ...
  given reader: Reader[structures.CompletionClientCapabilities.CompletionItem] =
    Pickle.macroR
  given writer: Writer[structures.CompletionClientCapabilities.CompletionItem] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionClientCapabilities_CompletionItem_TagSupportCodec:
  ...
  given reader: Reader[
    structures.CompletionClientCapabilities.CompletionItem.TagSupport
  ] = Pickle.macroR
  given writer: Writer[
    structures.CompletionClientCapabilities.CompletionItem.TagSupport
  ] = upickle.default.macroW
...
private[lsp] trait structures_CompletionClientCapabilities_CompletionItem_ResolveSupportCodec:
  import structures.CompletionClientCapabilities.CompletionItem.*
  given reader: Reader[
    structures.CompletionClientCapabilities.CompletionItem.ResolveSupport
  ] = Pickle.macroR
  given writer: Writer[
    structures.CompletionClientCapabilities.CompletionItem.ResolveSupport
  ] = upickle.default.macroW
...
private[lsp] trait structures_CompletionClientCapabilities_CompletionItem_InsertTextModeSupportCodec:
  import structures.CompletionClientCapabilities.CompletionItem.*
  given reader: Reader[
    structures.CompletionClientCapabilities.CompletionItem.InsertTextModeSupport
  ] = Pickle.macroR
  given writer: Writer[
    structures.CompletionClientCapabilities.CompletionItem.InsertTextModeSupport
  ] = upickle.default.macroW
...
private[lsp] trait structures_CompletionClientCapabilities_CompletionItemKindCodec:
  import structures.CompletionClientCapabilities.*
  given reader
      : Reader[structures.CompletionClientCapabilities.CompletionItemKind] =
    Pickle.macroR
  given writer
      : Writer[structures.CompletionClientCapabilities.CompletionItemKind] =
    upickle.default.macroW

private[lsp] trait structures_CompletionClientCapabilities_CompletionListCodec:
  import structures.CompletionClientCapabilities.*
  given reader: Reader[structures.CompletionClientCapabilities.CompletionList] =
    Pickle.macroR
  given writer: Writer[structures.CompletionClientCapabilities.CompletionList] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionItemCodec:
  ...
  private given rd0: Reader[(String | structures.MarkupContent)] =
    badMerge[(String | structures.MarkupContent)](
      stringCodec,
      structures.MarkupContent.reader
    )
  private given wt0: Writer[(String | structures.MarkupContent)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(String | structures.MarkupContent)] { _v =>
        (_v: @unchecked) match
          case v: String => writeJs[String](v)
          case v: structures.MarkupContent =>
            writeJs[structures.MarkupContent](v)
      }
  private given rd1
      : Reader[(structures.TextEdit | structures.InsertReplaceEdit)] =
    badMerge[(structures.TextEdit | structures.InsertReplaceEdit)](
      structures.TextEdit.reader,
      structures.InsertReplaceEdit.reader
    )
  private given wt1
      : Writer[(structures.TextEdit | structures.InsertReplaceEdit)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(structures.TextEdit | structures.InsertReplaceEdit)] { _v =>
        (_v: @unchecked) match
          case v: structures.TextEdit => writeJs[structures.TextEdit](v)
          case v: structures.InsertReplaceEdit =>
            writeJs[structures.InsertReplaceEdit](v)
      }
...
private[lsp] trait structures_CompletionItemLabelDetailsCodec:
  ...
  given writer: Writer[structures.CompletionItemLabelDetails] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionList_ItemDefaultsCodec:
  ...
  private given rd0: Reader[(structures.Range | ItemDefaults.InsertReplace)] =
    badMerge[(structures.Range | ItemDefaults.InsertReplace)](
      structures.Range.reader,
      ItemDefaults.InsertReplace.reader
    )
  private given wt0: Writer[(structures.Range | ItemDefaults.InsertReplace)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(structures.Range | ItemDefaults.InsertReplace)] { _v =>
        (_v: @unchecked) match
          case v: structures.Range => writeJs[structures.Range](v)
          case v: ItemDefaults.InsertReplace =>
            writeJs[ItemDefaults.InsertReplace](v)
      }
  given reader: Reader[structures.CompletionList.ItemDefaults] = Pickle.macroR
  given writer: Writer[structures.CompletionList.ItemDefaults] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionList_ItemDefaults_InsertReplaceCodec:
  ...
  given reader: Reader[structures.CompletionList.ItemDefaults.InsertReplace] =
    Pickle.macroR
  given writer: Writer[structures.CompletionList.ItemDefaults.InsertReplace] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionOptions_CompletionItemCodec:
  ...
  given reader: Reader[structures.CompletionOptions.CompletionItem] =
    Pickle.macroR
  given writer: Writer[structures.CompletionOptions.CompletionItem] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.CompletionRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_CompletionRegistrationOptions_CompletionItemCodec:
  ...
  given reader
      : Reader[structures.CompletionRegistrationOptions.CompletionItem] =
    Pickle.macroR
  given writer
      : Writer[structures.CompletionRegistrationOptions.CompletionItem] =
    upickle.default.macroW
...
private[lsp] trait structures_DeclarationClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.DeclarationClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DeclarationRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DeclarationRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DeclarationRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DefinitionClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.DefinitionClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DefinitionRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.DefinitionRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DiagnosticClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.DiagnosticClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DiagnosticRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.DiagnosticRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DiagnosticRelatedInformationCodec:
  ...
  given writer: Writer[structures.DiagnosticRelatedInformation] =
    upickle.default.macroW

private[lsp] trait structures_DiagnosticServerCancellationDataCodec:
  import structures.*
  given reader: Reader[structures.DiagnosticServerCancellationData] =
    Pickle.macroR
  given writer: Writer[structures.DiagnosticServerCancellationData] =
    upickle.default.macroW

private[lsp] trait structures_DiagnosticWorkspaceClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DiagnosticWorkspaceClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DiagnosticWorkspaceClientCapabilities] =
    upickle.default.macroW

private[lsp] trait structures_DidChangeConfigurationClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DidChangeConfigurationClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DidChangeConfigurationClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DidChangeConfigurationParamsCodec:
  ...
  given writer: Writer[structures.DidChangeConfigurationParams] =
    upickle.default.macroW

private[lsp] trait structures_DidChangeConfigurationRegistrationOptionsCodec:
  import structures.*
  private given rd0: Reader[(String | Vector[String])] =
    badMerge[(String | Vector[String])](
      stringCodec,
      upickle.default.reader[Vector[String]]
    )
  private given wt0: Writer[(String | Vector[String])] =
    upickle.default.writer[ujson.Value].comap[(String | Vector[String])] { _v =>
      (_v: @unchecked) match
        case v: Vector[?] =>
          writeJs[Vector[String]](v.asInstanceOf[Vector[String]])
        case v: String => writeJs[String](v)
    }
  given reader: Reader[structures.DidChangeConfigurationRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DidChangeConfigurationRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DidChangeNotebookDocumentParamsCodec:
  import structures.*
  given reader: Reader[structures.DidChangeNotebookDocumentParams] =
    Pickle.macroR
  given writer: Writer[structures.DidChangeNotebookDocumentParams] =
    upickle.default.macroW
...
private[lsp] trait structures_DidChangeTextDocumentParamsCodec:
  ...
  given writer: Writer[structures.DidChangeTextDocumentParams] =
    upickle.default.macroW

private[lsp] trait structures_DidChangeWatchedFilesClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DidChangeWatchedFilesClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DidChangeWatchedFilesClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DidChangeWatchedFilesParamsCodec:
  ...
  given writer: Writer[structures.DidChangeWatchedFilesParams] =
    upickle.default.macroW

private[lsp] trait structures_DidChangeWatchedFilesRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DidChangeWatchedFilesRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DidChangeWatchedFilesRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_DidChangeWorkspaceFoldersParamsCodec:
  import structures.*
  given reader: Reader[structures.DidChangeWorkspaceFoldersParams] =
    Pickle.macroR
  given writer: Writer[structures.DidChangeWorkspaceFoldersParams] =
    upickle.default.macroW

private[lsp] trait structures_DidCloseNotebookDocumentParamsCodec:
  import structures.*
  given reader: Reader[structures.DidCloseNotebookDocumentParams] =
    Pickle.macroR
  given writer: Writer[structures.DidCloseNotebookDocumentParams] =
    upickle.default.macroW
...
private[lsp] trait structures_DidCloseTextDocumentParamsCodec:
  ...
  given writer: Writer[structures.DidCloseTextDocumentParams] =
    upickle.default.macroW
...
private[lsp] trait structures_DidOpenNotebookDocumentParamsCodec:
  ...
  given writer: Writer[structures.DidOpenNotebookDocumentParams] =
    upickle.default.macroW
...
private[lsp] trait structures_DidOpenTextDocumentParamsCodec:
  ...
  given writer: Writer[structures.DidOpenTextDocumentParams] =
    upickle.default.macroW
...
private[lsp] trait structures_DidSaveNotebookDocumentParamsCodec:
  ...
  given writer: Writer[structures.DidSaveNotebookDocumentParams] =
    upickle.default.macroW
...
private[lsp] trait structures_DidSaveTextDocumentParamsCodec:
  ...
  given writer: Writer[structures.DidSaveTextDocumentParams] =
    upickle.default.macroW

private[lsp] trait structures_DocumentColorClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DocumentColorClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DocumentColorClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentColorRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentColorRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentColorRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentDiagnosticParamsCodec:
  ...
  given writer: Writer[structures.DocumentDiagnosticParams] =
    upickle.default.macroW

private[lsp] trait structures_DocumentDiagnosticReportPartialResultCodec:
  import structures.*
  private given rd0: Reader[
    ...
    badMerge[
      ...
      structures.FullDocumentDiagnosticReport.reader,
      structures.UnchangedDocumentDiagnosticReport.reader
    )
  private given wt0: Writer[
    (structures.FullDocumentDiagnosticReport |
      structures.UnchangedDocumentDiagnosticReport)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: structures.FullDocumentDiagnosticReport =>
            writeJs[structures.FullDocumentDiagnosticReport](v)
          case v: structures.UnchangedDocumentDiagnosticReport =>
            writeJs[structures.UnchangedDocumentDiagnosticReport](v)
      }
  given reader: Reader[structures.DocumentDiagnosticReportPartialResult] =
    Pickle.macroR
  given writer: Writer[structures.DocumentDiagnosticReportPartialResult] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentFormattingClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DocumentFormattingClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DocumentFormattingClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentFormattingOptionsCodec:
  ...
  given writer: Writer[structures.DocumentFormattingOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentFormattingParamsCodec:
  ...
  given writer: Writer[structures.DocumentFormattingParams] =
    upickle.default.macroW

private[lsp] trait structures_DocumentFormattingRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentFormattingRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentFormattingRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentHighlightClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DocumentHighlightClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DocumentHighlightClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentHighlightOptionsCodec:
  ...
  given writer: Writer[structures.DocumentHighlightOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentHighlightParamsCodec:
  ...
  given writer: Writer[structures.DocumentHighlightParams] =
    upickle.default.macroW

private[lsp] trait structures_DocumentHighlightRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentHighlightRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentHighlightRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentLinkClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DocumentLinkClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DocumentLinkClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentLinkRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentLinkRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentLinkRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_DocumentOnTypeFormattingClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DocumentOnTypeFormattingClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DocumentOnTypeFormattingClientCapabilities] =
    upickle.default.macroW

private[lsp] trait structures_DocumentOnTypeFormattingOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentOnTypeFormattingOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentOnTypeFormattingOptions] =
    upickle.default.macroW

private[lsp] trait structures_DocumentOnTypeFormattingParamsCodec:
  import structures.*
  given reader: Reader[structures.DocumentOnTypeFormattingParams] =
    Pickle.macroR
  given writer: Writer[structures.DocumentOnTypeFormattingParams] =
    upickle.default.macroW

private[lsp] trait structures_DocumentOnTypeFormattingRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentOnTypeFormattingRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentOnTypeFormattingRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_DocumentRangeFormattingClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DocumentRangeFormattingClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DocumentRangeFormattingClientCapabilities] =
    upickle.default.macroW

private[lsp] trait structures_DocumentRangeFormattingOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentRangeFormattingOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentRangeFormattingOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentRangeFormattingParamsCodec:
  ...
  given writer: Writer[structures.DocumentRangeFormattingParams] =
    upickle.default.macroW

private[lsp] trait structures_DocumentRangeFormattingRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentRangeFormattingRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentRangeFormattingRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentSymbolClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.DocumentSymbolClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.DocumentSymbolClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentSymbolClientCapabilities_SymbolKindCodec:
  ...
  given reader: Reader[structures.DocumentSymbolClientCapabilities.SymbolKind] =
    Pickle.macroR
  given writer: Writer[structures.DocumentSymbolClientCapabilities.SymbolKind] =
    upickle.default.macroW

private[lsp] trait structures_DocumentSymbolClientCapabilities_TagSupportCodec:
  import structures.DocumentSymbolClientCapabilities.*
  given reader: Reader[structures.DocumentSymbolClientCapabilities.TagSupport] =
    Pickle.macroR
  given writer: Writer[structures.DocumentSymbolClientCapabilities.TagSupport] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentSymbolOptionsCodec:
  ...
  given writer: Writer[structures.DocumentSymbolOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_DocumentSymbolRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.DocumentSymbolRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.DocumentSymbolRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_ExecuteCommandClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.ExecuteCommandClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.ExecuteCommandClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_ExecuteCommandOptionsCodec:
  ...
  given writer: Writer[structures.ExecuteCommandOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_ExecuteCommandRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.ExecuteCommandRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.ExecuteCommandRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_FileOperationClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.FileOperationClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.FileOperationClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_FileOperationPatternOptionsCodec:
  ...
  given writer: Writer[structures.FileOperationPatternOptions] =
    upickle.default.macroW

private[lsp] trait structures_FileOperationRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.FileOperationRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.FileOperationRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_FoldingRangeClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.FoldingRangeClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.FoldingRangeClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_FoldingRangeClientCapabilities_FoldingRangeKindCodec:
  ...
  given reader
      : Reader[structures.FoldingRangeClientCapabilities.FoldingRangeKind] =
    Pickle.macroR
  given writer
      : Writer[structures.FoldingRangeClientCapabilities.FoldingRangeKind] =
    upickle.default.macroW

private[lsp] trait structures_FoldingRangeClientCapabilities_FoldingRangeCodec:
  import structures.FoldingRangeClientCapabilities.*
  given reader: Reader[structures.FoldingRangeClientCapabilities.FoldingRange] =
    Pickle.macroR
  given writer: Writer[structures.FoldingRangeClientCapabilities.FoldingRange] =
    upickle.default.macroW
...
private[lsp] trait structures_FoldingRangeRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.FoldingRangeRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.FoldingRangeRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_FullDocumentDiagnosticReportCodec:
  ...
  given writer: Writer[structures.FullDocumentDiagnosticReport] =
    upickle.default.macroW
...
private[lsp] trait structures_GeneralClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.GeneralClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_GeneralClientCapabilities_StaleRequestSupportCodec:
  ...
  given reader
      : Reader[structures.GeneralClientCapabilities.StaleRequestSupport] =
    Pickle.macroR
  given writer
      : Writer[structures.GeneralClientCapabilities.StaleRequestSupport] =
    upickle.default.macroW
...
private[lsp] trait structures_HoverCodec:
  ...
  private given rd0: Reader[
    ...
    badMerge[
      ...
      structures.MarkupContent.reader,
      aliases.MarkedString.reader,
      upickle.default.reader[Vector[aliases.MarkedString]]
    )
  private given wt0: Writer[
    (structures.MarkupContent | aliases.MarkedString |
      Vector[aliases.MarkedString])
    ...
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Vector[?] =>
            writeJs[Vector[aliases.MarkedString]](
              v.asInstanceOf[Vector[aliases.MarkedString]]
            )
          case v: structures.MarkupContent =>
            writeJs[structures.MarkupContent](v)
...
private[lsp] trait structures_HoverClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.HoverClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_HoverRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.HoverRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_ImplementationClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.ImplementationClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.ImplementationClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_ImplementationOptionsCodec:
  ...
  given writer: Writer[structures.ImplementationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_ImplementationRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.ImplementationRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.ImplementationRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_InitializeParams_ClientInfoCodec:
  ...
  given writer: Writer[structures.InitializeParams.ClientInfo] =
    upickle.default.macroW
...
private[lsp] trait structures_InitializeResult_ServerInfoCodec:
  ...
  given writer: Writer[structures.InitializeResult.ServerInfo] =
    upickle.default.macroW
...
private[lsp] trait structures_InlayHintCodec:
  ...
  private given rd0: Reader[(String | Vector[structures.InlayHintLabelPart])] =
    badMerge[(String | Vector[structures.InlayHintLabelPart])](
      stringCodec,
      upickle.default.reader[Vector[structures.InlayHintLabelPart]]
    )
  private given wt0: Writer[(String | Vector[structures.InlayHintLabelPart])] =
    upickle.default
      .writer[ujson.Value]
      .comap[(String | Vector[structures.InlayHintLabelPart])] { _v =>
        (_v: @unchecked) match
          case v: Vector[?] =>
            writeJs[Vector[structures.InlayHintLabelPart]](
              v.asInstanceOf[Vector[structures.InlayHintLabelPart]]
            )
          case v: String => writeJs[String](v)
      }
...
private[lsp] trait structures_InlayHintClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.InlayHintClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_InlayHintClientCapabilities_ResolveSupportCodec:
  ...
  given reader: Reader[structures.InlayHintClientCapabilities.ResolveSupport] =
    Pickle.macroR
  given writer: Writer[structures.InlayHintClientCapabilities.ResolveSupport] =
    upickle.default.macroW
...
private[lsp] trait structures_InlayHintRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.InlayHintRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_InlayHintWorkspaceClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.InlayHintWorkspaceClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.InlayHintWorkspaceClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_InlineValueClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.InlineValueClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_InlineValueEvaluatableExpressionCodec:
  import structures.*
  given reader: Reader[structures.InlineValueEvaluatableExpression] =
    Pickle.macroR
  given writer: Writer[structures.InlineValueEvaluatableExpression] =
    upickle.default.macroW
...
private[lsp] trait structures_InlineValueRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.InlineValueRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.InlineValueRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_InlineValueVariableLookupCodec:
  ...
  given writer: Writer[structures.InlineValueVariableLookup] =
    upickle.default.macroW

private[lsp] trait structures_InlineValueWorkspaceClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.InlineValueWorkspaceClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.InlineValueWorkspaceClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_LinkedEditingRangeClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.LinkedEditingRangeClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.LinkedEditingRangeClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_LinkedEditingRangeOptionsCodec:
  ...
  given writer: Writer[structures.LinkedEditingRangeOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_LinkedEditingRangeParamsCodec:
  ...
  given writer: Writer[structures.LinkedEditingRangeParams] =
    upickle.default.macroW

private[lsp] trait structures_LinkedEditingRangeRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.LinkedEditingRangeRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.LinkedEditingRangeRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_MarkdownClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.MarkdownClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_MonikerClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.MonikerClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_MonikerRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.MonikerRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookCellArrayChangeCodec:
  ...
  given writer: Writer[structures.NotebookCellArrayChange] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookCellTextDocumentFilterCodec:
  ...
  private given rd0: Reader[(String | aliases.NotebookDocumentFilter)] =
    badMerge[(String | aliases.NotebookDocumentFilter)](
      stringCodec,
      aliases.NotebookDocumentFilter.reader
    )
  private given wt0: Writer[(String | aliases.NotebookDocumentFilter)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(String | aliases.NotebookDocumentFilter)] { _v =>
        (_v: @unchecked) match
          case v: String => writeJs[String](v)
          case v: aliases.NotebookDocumentFilter =>
            writeJs[aliases.NotebookDocumentFilter](v)
      }
  given reader: Reader[structures.NotebookCellTextDocumentFilter] =
    Pickle.macroR
  given writer: Writer[structures.NotebookCellTextDocumentFilter] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookDocumentChangeEventCodec:
  ...
  given writer: Writer[structures.NotebookDocumentChangeEvent] =
    upickle.default.macroW

private[lsp] trait structures_NotebookDocumentChangeEvent_CellsCodec:
  import structures.NotebookDocumentChangeEvent.*
  given reader: Reader[structures.NotebookDocumentChangeEvent.Cells] =
    Pickle.macroR
  given writer: Writer[structures.NotebookDocumentChangeEvent.Cells] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookDocumentChangeEvent_Cells_StructureCodec:
  ...
  given reader: Reader[structures.NotebookDocumentChangeEvent.Cells.Structure] =
    Pickle.macroR
  given writer: Writer[structures.NotebookDocumentChangeEvent.Cells.Structure] =
    upickle.default.macroW

private[lsp] trait structures_NotebookDocumentChangeEvent_Cells_TextContentCodec:
  import structures.NotebookDocumentChangeEvent.Cells.*
  given reader
      : Reader[structures.NotebookDocumentChangeEvent.Cells.TextContent] =
    Pickle.macroR
  given writer
      : Writer[structures.NotebookDocumentChangeEvent.Cells.TextContent] =
    upickle.default.macroW

private[lsp] trait structures_NotebookDocumentClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.NotebookDocumentClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.NotebookDocumentClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookDocumentIdentifierCodec:
  ...
  given writer: Writer[structures.NotebookDocumentIdentifier] =
    upickle.default.macroW

private[lsp] trait structures_NotebookDocumentSyncClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.NotebookDocumentSyncClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.NotebookDocumentSyncClientCapabilities] =
    upickle.default.macroW

private[lsp] trait structures_NotebookDocumentSyncOptionsCodec:
  import structures.*
  private given rd0: Reader[
    (NotebookDocumentSyncOptions.ByDocumentAndCells |
      NotebookDocumentSyncOptions.ByCells)
  ] =
    badMerge[
      (NotebookDocumentSyncOptions.ByDocumentAndCells |
        NotebookDocumentSyncOptions.ByCells)
    ](
      NotebookDocumentSyncOptions.ByDocumentAndCells.reader,
      NotebookDocumentSyncOptions.ByCells.reader
    )
  private given wt0: Writer[
    (NotebookDocumentSyncOptions.ByDocumentAndCells |
      NotebookDocumentSyncOptions.ByCells)
    ...
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: NotebookDocumentSyncOptions.ByDocumentAndCells =>
            writeJs[NotebookDocumentSyncOptions.ByDocumentAndCells](v)
          case v: NotebookDocumentSyncOptions.ByCells =>
            writeJs[NotebookDocumentSyncOptions.ByCells](v)
      }
  given reader: Reader[structures.NotebookDocumentSyncOptions] = Pickle.macroR
  given writer: Writer[structures.NotebookDocumentSyncOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookDocumentSyncOptions_ByDocumentAndCellsCodec:
  ...
  given reader
      : Reader[structures.NotebookDocumentSyncOptions.ByDocumentAndCells] =
    Pickle.macroR
  given writer
      : Writer[structures.NotebookDocumentSyncOptions.ByDocumentAndCells] =
    upickle.default.macroW
end structures_NotebookDocumentSyncOptions_ByDocumentAndCellsCodec
...
private[lsp] trait structures_NotebookDocumentSyncOptions_ByDocumentAndCells_CellCodec:
  ...
  given reader
      : Reader[structures.NotebookDocumentSyncOptions.ByDocumentAndCells.Cell] =
    Pickle.macroR
  given writer
      : Writer[structures.NotebookDocumentSyncOptions.ByDocumentAndCells.Cell] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookDocumentSyncOptions_ByCellsCodec:
  ...
  given reader: Reader[structures.NotebookDocumentSyncOptions.ByCells] =
    Pickle.macroR
  given writer: Writer[structures.NotebookDocumentSyncOptions.ByCells] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookDocumentSyncOptions_ByCells_CellCodec:
  ...
  given reader: Reader[structures.NotebookDocumentSyncOptions.ByCells.Cell] =
    Pickle.macroR
  given writer: Writer[structures.NotebookDocumentSyncOptions.ByCells.Cell] =
    upickle.default.macroW

private[lsp] trait structures_NotebookDocumentSyncRegistrationOptionsCodec:
  import structures.*
  private given rd0: Reader[
    (NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells |
      NotebookDocumentSyncRegistrationOptions.ByCells)
  ] =
    badMerge[
      (NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells |
        NotebookDocumentSyncRegistrationOptions.ByCells)
    ](
      NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells.reader,
      NotebookDocumentSyncRegistrationOptions.ByCells.reader
    )
  private given wt0: Writer[
    (NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells |
      NotebookDocumentSyncRegistrationOptions.ByCells)
    ...
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells =>
            writeJs[NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells](
              v
            )
          case v: NotebookDocumentSyncRegistrationOptions.ByCells =>
            writeJs[NotebookDocumentSyncRegistrationOptions.ByCells](v)
      }
  given reader: Reader[structures.NotebookDocumentSyncRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.NotebookDocumentSyncRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_NotebookDocumentSyncRegistrationOptions_ByDocumentAndCellsCodec:
  ...
  given reader: Reader[
    structures.NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells
  ] = Pickle.macroR
  given writer: Writer[
    structures.NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells
  ] = upickle.default.macroW
end structures_NotebookDocumentSyncRegistrationOptions_ByDocumentAndCellsCodec
...
private[lsp] trait structures_NotebookDocumentSyncRegistrationOptions_ByDocumentAndCells_CellCodec:
  ...
  given reader: Reader[
    structures.NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells.Cell
  ] = Pickle.macroR
  given writer: Writer[
    structures.NotebookDocumentSyncRegistrationOptions.ByDocumentAndCells.Cell
  ] = upickle.default.macroW
...
private[lsp] trait structures_NotebookDocumentSyncRegistrationOptions_ByCellsCodec:
  ...
  given reader
      : Reader[structures.NotebookDocumentSyncRegistrationOptions.ByCells] =
    Pickle.macroR
  given writer
      : Writer[structures.NotebookDocumentSyncRegistrationOptions.ByCells] =
    upickle.default.macroW
end structures_NotebookDocumentSyncRegistrationOptions_ByCellsCodec
...
private[lsp] trait structures_NotebookDocumentSyncRegistrationOptions_ByCells_CellCodec:
  ...
  given reader: Reader[
    structures.NotebookDocumentSyncRegistrationOptions.ByCells.Cell
  ] = Pickle.macroR
  given writer: Writer[
    structures.NotebookDocumentSyncRegistrationOptions.ByCells.Cell
  ] = upickle.default.macroW
...
private[lsp] trait structures_OptionalVersionedTextDocumentIdentifierCodec:
  import structures.*
  given reader: Reader[structures.OptionalVersionedTextDocumentIdentifier] =
    Pickle.macroR
  given writer: Writer[structures.OptionalVersionedTextDocumentIdentifier] =
    upickle.default.macroW

private[lsp] trait structures_ParameterInformationCodec:
  import structures.*
  private given rd0: Reader[(String | (runtime.uinteger, runtime.uinteger))] =
    badMerge[(String | (runtime.uinteger, runtime.uinteger))](
      stringCodec,
      upickle.default.reader[(runtime.uinteger, runtime.uinteger)]
    )
  private given wt0: Writer[(String | (runtime.uinteger, runtime.uinteger))] =
    upickle.default
      .writer[ujson.Value]
      .comap[(String | (runtime.uinteger, runtime.uinteger))] { _v =>
        (_v: @unchecked) match
          case v: String => writeJs[String](v)
          case v: (runtime.uinteger, runtime.uinteger) =>
            writeJs[(runtime.uinteger, runtime.uinteger)](v)
      }
  private given rd1: Reader[(String | structures.MarkupContent)] =
    badMerge[(String | structures.MarkupContent)](
      stringCodec,
...
private[lsp] trait structures_PublishDiagnosticsClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.PublishDiagnosticsClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.PublishDiagnosticsClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_PublishDiagnosticsClientCapabilities_TagSupportCodec:
  ...
  given reader
      : Reader[structures.PublishDiagnosticsClientCapabilities.TagSupport] =
    Pickle.macroR
  given writer
      : Writer[structures.PublishDiagnosticsClientCapabilities.TagSupport] =
    upickle.default.macroW
...
private[lsp] trait structures_PublishDiagnosticsParamsCodec:
  ...
  given writer: Writer[structures.PublishDiagnosticsParams] =
    upickle.default.macroW
...
private[lsp] trait structures_ReferenceClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.ReferenceClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_ReferenceRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.ReferenceRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_RegularExpressionsClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.RegularExpressionsClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.RegularExpressionsClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_RelatedFullDocumentDiagnosticReportCodec:
  ...
  given reader: Reader[structures.RelatedFullDocumentDiagnosticReport] =
    Pickle.macroR
  given writer: Writer[structures.RelatedFullDocumentDiagnosticReport] =
    upickle.default.macroW
...
private[lsp] trait structures_RelatedUnchangedDocumentDiagnosticReportCodec:
  ...
  given reader: Reader[structures.RelatedUnchangedDocumentDiagnosticReport] =
    Pickle.macroR
  given writer: Writer[structures.RelatedUnchangedDocumentDiagnosticReport] =
    upickle.default.macroW
...
private[lsp] trait structures_RelativePatternCodec:
  ...
  private given rd0: Reader[(structures.WorkspaceFolder | runtime.Uri)] =
    badMerge[(structures.WorkspaceFolder | runtime.Uri)](
      structures.WorkspaceFolder.reader,
      upickle.default.reader[runtime.Uri]
    )
  private given wt0: Writer[(structures.WorkspaceFolder | runtime.Uri)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(structures.WorkspaceFolder | runtime.Uri)] { _v =>
        (_v: @unchecked) match
          case v: structures.WorkspaceFolder =>
            writeJs[structures.WorkspaceFolder](v)
...
private[lsp] trait structures_RenameClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.RenameClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_RenameRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.RenameRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_SelectionRangeClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.SelectionRangeClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.SelectionRangeClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_SelectionRangeOptionsCodec:
  ...
  given writer: Writer[structures.SelectionRangeOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_SelectionRangeRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.SelectionRangeRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.SelectionRangeRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.SemanticTokensClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.SemanticTokensClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensClientCapabilities_RequestsCodec:
  ...
  private given rd0: Reader[(Boolean | Requests.Range)] =
    badMerge[(Boolean | Requests.Range)](
      upickle.default.reader[Boolean],
      Requests.Range.reader
    )
  private given wt0: Writer[(Boolean | Requests.Range)] =
    upickle.default.writer[ujson.Value].comap[(Boolean | Requests.Range)] {
      _v =>
        (_v: @unchecked) match
  ...
  private given rd1: Reader[(Boolean | Requests.Delta)] =
    badMerge[(Boolean | Requests.Delta)](
      upickle.default.reader[Boolean],
      Requests.Delta.reader
    )
  private given wt1: Writer[(Boolean | Requests.Delta)] =
    upickle.default.writer[ujson.Value].comap[(Boolean | Requests.Delta)] {
      _v =>
        (_v: @unchecked) match
          case v: Boolean        => writeJs[Boolean](v)
  ...
  given reader: Reader[structures.SemanticTokensClientCapabilities.Requests] =
    Pickle.macroR
  given writer: Writer[structures.SemanticTokensClientCapabilities.Requests] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensClientCapabilities_Requests_RangeCodec:
  ...
  given reader
      : Reader[structures.SemanticTokensClientCapabilities.Requests.Range] =
    Pickle.macroR
  given writer
      : Writer[structures.SemanticTokensClientCapabilities.Requests.Range] =
    upickle.default.macroW

private[lsp] trait structures_SemanticTokensClientCapabilities_Requests_DeltaCodec:
  import structures.SemanticTokensClientCapabilities.Requests.*
  given reader
      : Reader[structures.SemanticTokensClientCapabilities.Requests.Delta] =
    Pickle.macroR
  given writer
      : Writer[structures.SemanticTokensClientCapabilities.Requests.Delta] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensDeltaParamsCodec:
  ...
  given writer: Writer[structures.SemanticTokensDeltaParams] =
    upickle.default.macroW

private[lsp] trait structures_SemanticTokensDeltaPartialResultCodec:
  import structures.*
  given reader: Reader[structures.SemanticTokensDeltaPartialResult] =
    Pickle.macroR
  given writer: Writer[structures.SemanticTokensDeltaPartialResult] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensOptionsCodec:
  ...
  private given rd0: Reader[(Boolean | SemanticTokensOptions.Range)] =
    badMerge[(Boolean | SemanticTokensOptions.Range)](
      upickle.default.reader[Boolean],
      SemanticTokensOptions.Range.reader
    )
  private given wt0: Writer[(Boolean | SemanticTokensOptions.Range)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | SemanticTokensOptions.Range)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: SemanticTokensOptions.Range =>
            writeJs[SemanticTokensOptions.Range](v)
      }
  private given rd1: Reader[(Boolean | SemanticTokensOptions.Delta)] =
    badMerge[(Boolean | SemanticTokensOptions.Delta)](
      upickle.default.reader[Boolean],
      SemanticTokensOptions.Delta.reader
    )
  private given wt1: Writer[(Boolean | SemanticTokensOptions.Delta)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | SemanticTokensOptions.Delta)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: SemanticTokensOptions.Delta =>
            writeJs[SemanticTokensOptions.Delta](v)
      }
  given reader: Reader[structures.SemanticTokensOptions] = Pickle.macroR
  given writer: Writer[structures.SemanticTokensOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensOptions_RangeCodec:
  ...
  given writer: Writer[structures.SemanticTokensOptions.Range] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensOptions_DeltaCodec:
  ...
  given writer: Writer[structures.SemanticTokensOptions.Delta] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensPartialResultCodec:
  ...
  given writer: Writer[structures.SemanticTokensPartialResult] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensRangeParamsCodec:
  ...
  given writer: Writer[structures.SemanticTokensRangeParams] =
    upickle.default.macroW

private[lsp] trait structures_SemanticTokensRegistrationOptionsCodec:
  import structures.*
  private given rd1
      : Reader[(Boolean | SemanticTokensRegistrationOptions.Range)] =
    badMerge[(Boolean | SemanticTokensRegistrationOptions.Range)](
      upickle.default.reader[Boolean],
      SemanticTokensRegistrationOptions.Range.reader
    )
  private given wt1
      : Writer[(Boolean | SemanticTokensRegistrationOptions.Range)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | SemanticTokensRegistrationOptions.Range)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: SemanticTokensRegistrationOptions.Range =>
            writeJs[SemanticTokensRegistrationOptions.Range](v)
      }
  private given rd2
      : Reader[(Boolean | SemanticTokensRegistrationOptions.Delta)] =
    badMerge[(Boolean | SemanticTokensRegistrationOptions.Delta)](
      upickle.default.reader[Boolean],
      SemanticTokensRegistrationOptions.Delta.reader
    )
  private given wt2
      : Writer[(Boolean | SemanticTokensRegistrationOptions.Delta)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | SemanticTokensRegistrationOptions.Delta)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: SemanticTokensRegistrationOptions.Delta =>
            writeJs[SemanticTokensRegistrationOptions.Delta](v)
      }
  given reader: Reader[structures.SemanticTokensRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.SemanticTokensRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_SemanticTokensRegistrationOptions_RangeCodec:
  ...
  given reader: Reader[structures.SemanticTokensRegistrationOptions.Range] =
    Pickle.macroR
  given writer: Writer[structures.SemanticTokensRegistrationOptions.Range] =
    upickle.default.macroW

private[lsp] trait structures_SemanticTokensRegistrationOptions_DeltaCodec:
  import structures.SemanticTokensRegistrationOptions.*
  given reader: Reader[structures.SemanticTokensRegistrationOptions.Delta] =
    Pickle.macroR
  given writer: Writer[structures.SemanticTokensRegistrationOptions.Delta] =
    upickle.default.macroW

private[lsp] trait structures_SemanticTokensWorkspaceClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.SemanticTokensWorkspaceClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.SemanticTokensWorkspaceClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_ServerCapabilitiesCodec:
  ...
  private given rd0: Reader[
    ...
    badMerge[
      ...
      structures.TextDocumentSyncOptions.reader,
      enumerations.TextDocumentSyncKind.reader
    )
  private given wt0: Writer[
    (structures.TextDocumentSyncOptions | enumerations.TextDocumentSyncKind)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: structures.TextDocumentSyncOptions =>
            writeJs[structures.TextDocumentSyncOptions](v)
          case v: enumerations.TextDocumentSyncKind =>
            writeJs[enumerations.TextDocumentSyncKind](v)
      }
  private given rd1: Reader[
    ...
    badMerge[
      ...
      structures.NotebookDocumentSyncOptions.reader,
      structures.NotebookDocumentSyncRegistrationOptions.reader
    )
  private given wt1: Writer[
    (structures.NotebookDocumentSyncOptions |
      structures.NotebookDocumentSyncRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: structures.NotebookDocumentSyncOptions =>
            writeJs[structures.NotebookDocumentSyncOptions](v)
          case v: structures.NotebookDocumentSyncRegistrationOptions =>
            writeJs[structures.NotebookDocumentSyncRegistrationOptions](v)
      }
  private given rd2: Reader[(Boolean | structures.HoverOptions)] =
    badMerge[(Boolean | structures.HoverOptions)](
      upickle.default.reader[Boolean],
      structures.HoverOptions.reader
    )
  private given wt2: Writer[(Boolean | structures.HoverOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.HoverOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean                 => writeJs[Boolean](v)
          case v: structures.HoverOptions => writeJs[structures.HoverOptions](v)
      }
  private given rd3: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.DeclarationOptions.reader,
      structures.DeclarationRegistrationOptions.reader
    )
  private given wt3: Writer[
    (Boolean | structures.DeclarationOptions |
      structures.DeclarationRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.DeclarationOptions =>
            writeJs[structures.DeclarationOptions](v)
          case v: structures.DeclarationRegistrationOptions =>
            writeJs[structures.DeclarationRegistrationOptions](v)
      }
  private given rd4: Reader[(Boolean | structures.DefinitionOptions)] =
    badMerge[(Boolean | structures.DefinitionOptions)](
      upickle.default.reader[Boolean],
      structures.DefinitionOptions.reader
    )
  private given wt4: Writer[(Boolean | structures.DefinitionOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.DefinitionOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.DefinitionOptions =>
            writeJs[structures.DefinitionOptions](v)
      }
  private given rd5: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.TypeDefinitionOptions.reader,
      structures.TypeDefinitionRegistrationOptions.reader
    )
  private given wt5: Writer[
    (Boolean | structures.TypeDefinitionOptions |
      structures.TypeDefinitionRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.TypeDefinitionOptions =>
            writeJs[structures.TypeDefinitionOptions](v)
          case v: structures.TypeDefinitionRegistrationOptions =>
            writeJs[structures.TypeDefinitionRegistrationOptions](v)
      }
  private given rd6: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.ImplementationOptions.reader,
      structures.ImplementationRegistrationOptions.reader
    )
  private given wt6: Writer[
    (Boolean | structures.ImplementationOptions |
      structures.ImplementationRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.ImplementationOptions =>
            writeJs[structures.ImplementationOptions](v)
          case v: structures.ImplementationRegistrationOptions =>
            writeJs[structures.ImplementationRegistrationOptions](v)
      }
  private given rd7: Reader[(Boolean | structures.ReferenceOptions)] =
    badMerge[(Boolean | structures.ReferenceOptions)](
      upickle.default.reader[Boolean],
      structures.ReferenceOptions.reader
    )
  private given wt7: Writer[(Boolean | structures.ReferenceOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.ReferenceOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.ReferenceOptions =>
            writeJs[structures.ReferenceOptions](v)
      }
  private given rd8: Reader[(Boolean | structures.DocumentHighlightOptions)] =
    badMerge[(Boolean | structures.DocumentHighlightOptions)](
      upickle.default.reader[Boolean],
      structures.DocumentHighlightOptions.reader
    )
  private given wt8: Writer[(Boolean | structures.DocumentHighlightOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.DocumentHighlightOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.DocumentHighlightOptions =>
            writeJs[structures.DocumentHighlightOptions](v)
      }
  private given rd9: Reader[(Boolean | structures.DocumentSymbolOptions)] =
    badMerge[(Boolean | structures.DocumentSymbolOptions)](
      upickle.default.reader[Boolean],
      structures.DocumentSymbolOptions.reader
    )
  private given wt9: Writer[(Boolean | structures.DocumentSymbolOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.DocumentSymbolOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.DocumentSymbolOptions =>
            writeJs[structures.DocumentSymbolOptions](v)
      }
  private given rd10: Reader[(Boolean | structures.CodeActionOptions)] =
    badMerge[(Boolean | structures.CodeActionOptions)](
      upickle.default.reader[Boolean],
      structures.CodeActionOptions.reader
    )
  private given wt10: Writer[(Boolean | structures.CodeActionOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.CodeActionOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.CodeActionOptions =>
            writeJs[structures.CodeActionOptions](v)
      }
  private given rd11: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.DocumentColorOptions.reader,
      structures.DocumentColorRegistrationOptions.reader
    )
  private given wt11: Writer[
    (Boolean | structures.DocumentColorOptions |
      structures.DocumentColorRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.DocumentColorOptions =>
            writeJs[structures.DocumentColorOptions](v)
          case v: structures.DocumentColorRegistrationOptions =>
            writeJs[structures.DocumentColorRegistrationOptions](v)
      }
  private given rd12: Reader[(Boolean | structures.WorkspaceSymbolOptions)] =
    badMerge[(Boolean | structures.WorkspaceSymbolOptions)](
      upickle.default.reader[Boolean],
      structures.WorkspaceSymbolOptions.reader
    )
  private given wt12: Writer[(Boolean | structures.WorkspaceSymbolOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.WorkspaceSymbolOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.WorkspaceSymbolOptions =>
            writeJs[structures.WorkspaceSymbolOptions](v)
      }
  private given rd13: Reader[(Boolean | structures.DocumentFormattingOptions)] =
    badMerge[(Boolean | structures.DocumentFormattingOptions)](
      upickle.default.reader[Boolean],
      structures.DocumentFormattingOptions.reader
    )
  private given wt13: Writer[(Boolean | structures.DocumentFormattingOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.DocumentFormattingOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.DocumentFormattingOptions =>
            writeJs[structures.DocumentFormattingOptions](v)
      }
  private given rd14
      : Reader[(Boolean | structures.DocumentRangeFormattingOptions)] =
    badMerge[(Boolean | structures.DocumentRangeFormattingOptions)](
      upickle.default.reader[Boolean],
      structures.DocumentRangeFormattingOptions.reader
    )
  private given wt14
      : Writer[(Boolean | structures.DocumentRangeFormattingOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.DocumentRangeFormattingOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.DocumentRangeFormattingOptions =>
            writeJs[structures.DocumentRangeFormattingOptions](v)
      }
  private given rd15: Reader[(Boolean | structures.RenameOptions)] =
    badMerge[(Boolean | structures.RenameOptions)](
      upickle.default.reader[Boolean],
      structures.RenameOptions.reader
    )
  private given wt15: Writer[(Boolean | structures.RenameOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.RenameOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.RenameOptions =>
            writeJs[structures.RenameOptions](v)
      }
  private given rd16: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.FoldingRangeOptions.reader,
      structures.FoldingRangeRegistrationOptions.reader
    )
  private given wt16: Writer[
    (Boolean | structures.FoldingRangeOptions |
      structures.FoldingRangeRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.FoldingRangeOptions =>
            writeJs[structures.FoldingRangeOptions](v)
          case v: structures.FoldingRangeRegistrationOptions =>
            writeJs[structures.FoldingRangeRegistrationOptions](v)
      }
  private given rd17: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.SelectionRangeOptions.reader,
      structures.SelectionRangeRegistrationOptions.reader
    )
  private given wt17: Writer[
    (Boolean | structures.SelectionRangeOptions |
      structures.SelectionRangeRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.SelectionRangeOptions =>
            writeJs[structures.SelectionRangeOptions](v)
          case v: structures.SelectionRangeRegistrationOptions =>
            writeJs[structures.SelectionRangeRegistrationOptions](v)
      }
  private given rd18: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.CallHierarchyOptions.reader,
      structures.CallHierarchyRegistrationOptions.reader
    )
  private given wt18: Writer[
    (Boolean | structures.CallHierarchyOptions |
      structures.CallHierarchyRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.CallHierarchyOptions =>
            writeJs[structures.CallHierarchyOptions](v)
          case v: structures.CallHierarchyRegistrationOptions =>
            writeJs[structures.CallHierarchyRegistrationOptions](v)
      }
  private given rd19: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.LinkedEditingRangeOptions.reader,
      structures.LinkedEditingRangeRegistrationOptions.reader
    )
  private given wt19: Writer[
    (Boolean | structures.LinkedEditingRangeOptions |
      structures.LinkedEditingRangeRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.LinkedEditingRangeOptions =>
            writeJs[structures.LinkedEditingRangeOptions](v)
          case v: structures.LinkedEditingRangeRegistrationOptions =>
            writeJs[structures.LinkedEditingRangeRegistrationOptions](v)
      }
  private given rd20: Reader[
    ...
    badMerge[
      ...
      structures.SemanticTokensOptions.reader,
      structures.SemanticTokensRegistrationOptions.reader
    )
  private given wt20: Writer[
    (structures.SemanticTokensOptions |
      structures.SemanticTokensRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: structures.SemanticTokensOptions =>
            writeJs[structures.SemanticTokensOptions](v)
          case v: structures.SemanticTokensRegistrationOptions =>
            writeJs[structures.SemanticTokensRegistrationOptions](v)
      }
  private given rd21: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.MonikerOptions.reader,
      structures.MonikerRegistrationOptions.reader
    )
  private given wt21: Writer[
    (Boolean | structures.MonikerOptions |
      structures.MonikerRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.MonikerOptions =>
            writeJs[structures.MonikerOptions](v)
          case v: structures.MonikerRegistrationOptions =>
            writeJs[structures.MonikerRegistrationOptions](v)
      }
  private given rd22: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.TypeHierarchyOptions.reader,
      structures.TypeHierarchyRegistrationOptions.reader
    )
  private given wt22: Writer[
    (Boolean | structures.TypeHierarchyOptions |
      structures.TypeHierarchyRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.TypeHierarchyOptions =>
            writeJs[structures.TypeHierarchyOptions](v)
          case v: structures.TypeHierarchyRegistrationOptions =>
            writeJs[structures.TypeHierarchyRegistrationOptions](v)
      }
  private given rd23: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.InlineValueOptions.reader,
      structures.InlineValueRegistrationOptions.reader
    )
  private given wt23: Writer[
    (Boolean | structures.InlineValueOptions |
      structures.InlineValueRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.InlineValueOptions =>
            writeJs[structures.InlineValueOptions](v)
          case v: structures.InlineValueRegistrationOptions =>
            writeJs[structures.InlineValueRegistrationOptions](v)
      }
  private given rd24: Reader[
    ...
    badMerge[
      ...
      upickle.default.reader[Boolean],
      structures.InlayHintOptions.reader,
      structures.InlayHintRegistrationOptions.reader
    )
  private given wt24: Writer[
    (Boolean | structures.InlayHintOptions |
      structures.InlayHintRegistrationOptions)
  ] =
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: Boolean => writeJs[Boolean](v)
          case v: structures.InlayHintOptions =>
            writeJs[structures.InlayHintOptions](v)
          case v: structures.InlayHintRegistrationOptions =>
            writeJs[structures.InlayHintRegistrationOptions](v)
      }
  private given rd25: Reader[
    ...
    badMerge[
      ...
      structures.DiagnosticOptions.reader,
      structures.DiagnosticRegistrationOptions.reader
    )
  private given wt25: Writer[
    (structures.DiagnosticOptions | structures.DiagnosticRegistrationOptions)
  ] =
    upickle.default
      .writer[ujson.Value]
      .comap[
        ...
        (_v: @unchecked) match
          case v: structures.DiagnosticOptions =>
            writeJs[structures.DiagnosticOptions](v)
          case v: structures.DiagnosticRegistrationOptions =>
            writeJs[structures.DiagnosticRegistrationOptions](v)
      }
...
private[lsp] trait structures_ServerCapabilities_WorkspaceCodec:
  ...
  given writer: Writer[structures.ServerCapabilities.Workspace] =
    upickle.default.macroW
...
private[lsp] trait structures_ShowDocumentClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.ShowDocumentClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.ShowDocumentClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_ShowMessageRequestClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.ShowMessageRequestClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.ShowMessageRequestClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_ShowMessageRequestClientCapabilities_MessageActionItemCodec:
  ...
  given reader: Reader[
    structures.ShowMessageRequestClientCapabilities.MessageActionItem
  ] = Pickle.macroR
  given writer: Writer[
    structures.ShowMessageRequestClientCapabilities.MessageActionItem
  ] = upickle.default.macroW
...
private[lsp] trait structures_ShowMessageRequestParamsCodec:
  ...
  given writer: Writer[structures.ShowMessageRequestParams] =
    upickle.default.macroW
...
private[lsp] trait structures_SignatureHelpClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.SignatureHelpClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.SignatureHelpClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_SignatureHelpClientCapabilities_SignatureInformationCodec:
  ...
  given reader: Reader[
    structures.SignatureHelpClientCapabilities.SignatureInformation
  ] = Pickle.macroR
  given writer: Writer[
    structures.SignatureHelpClientCapabilities.SignatureInformation
  ] = upickle.default.macroW
...
private[lsp] trait structures_SignatureHelpClientCapabilities_SignatureInformation_ParameterInformationCodec:
  ...
  given reader: Reader[
    structures.SignatureHelpClientCapabilities.SignatureInformation.ParameterInformation
  ] = Pickle.macroR
  given writer: Writer[
    structures.SignatureHelpClientCapabilities.SignatureInformation.ParameterInformation
  ] = upickle.default.macroW
...
private[lsp] trait structures_SignatureHelpRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.SignatureHelpRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.SignatureHelpRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_StaticRegistrationOptionsCodec:
  ...
  given writer: Writer[structures.StaticRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_TextDocumentChangeRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.TextDocumentChangeRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.TextDocumentChangeRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_TextDocumentClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.TextDocumentClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.TextDocumentClientCapabilities] =
    upickle.default.macroW

private[lsp] trait structures_TextDocumentEditCodec:
  import structures.*
  private given rd0
      : Reader[(structures.TextEdit | structures.AnnotatedTextEdit)] =
    badMerge[(structures.TextEdit | structures.AnnotatedTextEdit)](
      structures.TextEdit.reader,
      structures.AnnotatedTextEdit.reader
    )
  private given wt0
      : Writer[(structures.TextEdit | structures.AnnotatedTextEdit)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(structures.TextEdit | structures.AnnotatedTextEdit)] { _v =>
        (_v: @unchecked) match
          case v: structures.TextEdit => writeJs[structures.TextEdit](v)
          case v: structures.AnnotatedTextEdit =>
            writeJs[structures.AnnotatedTextEdit](v)
      }
...
private[lsp] trait structures_TextDocumentIdentifierCodec:
  ...
  given writer: Writer[structures.TextDocumentIdentifier] =
    upickle.default.macroW
...
private[lsp] trait structures_TextDocumentPositionParamsCodec:
  ...
  given writer: Writer[structures.TextDocumentPositionParams] =
    upickle.default.macroW

private[lsp] trait structures_TextDocumentRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.TextDocumentRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.TextDocumentRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_TextDocumentSaveRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.TextDocumentSaveRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.TextDocumentSaveRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_TextDocumentSyncClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.TextDocumentSyncClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.TextDocumentSyncClientCapabilities] =
    upickle.default.macroW

private[lsp] trait structures_TextDocumentSyncOptionsCodec:
  import structures.*
  private given rd0: Reader[(Boolean | structures.SaveOptions)] =
    badMerge[(Boolean | structures.SaveOptions)](
      upickle.default.reader[Boolean],
      structures.SaveOptions.reader
    )
  private given wt0: Writer[(Boolean | structures.SaveOptions)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(Boolean | structures.SaveOptions)] { _v =>
        (_v: @unchecked) match
          case v: Boolean                => writeJs[Boolean](v)
  ...
  given writer: Writer[structures.TextDocumentSyncOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_TypeDefinitionClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.TypeDefinitionClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.TypeDefinitionClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_TypeDefinitionOptionsCodec:
  ...
  given writer: Writer[structures.TypeDefinitionOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_TypeDefinitionRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.TypeDefinitionRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.TypeDefinitionRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_TypeHierarchyClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.TypeHierarchyClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.TypeHierarchyClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_TypeHierarchyPrepareParamsCodec:
  ...
  given writer: Writer[structures.TypeHierarchyPrepareParams] =
    upickle.default.macroW

private[lsp] trait structures_TypeHierarchyRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.TypeHierarchyRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.TypeHierarchyRegistrationOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_TypeHierarchySubtypesParamsCodec:
  ...
  given writer: Writer[structures.TypeHierarchySubtypesParams] =
    upickle.default.macroW
...
private[lsp] trait structures_TypeHierarchySupertypesParamsCodec:
  ...
  given writer: Writer[structures.TypeHierarchySupertypesParams] =
    upickle.default.macroW

private[lsp] trait structures_UnchangedDocumentDiagnosticReportCodec:
  import structures.*
  given reader: Reader[structures.UnchangedDocumentDiagnosticReport] =
    Pickle.macroR
  given writer: Writer[structures.UnchangedDocumentDiagnosticReport] =
    upickle.default.macroW
...
private[lsp] trait structures_VersionedNotebookDocumentIdentifierCodec:
  import structures.*
  given reader: Reader[structures.VersionedNotebookDocumentIdentifier] =
    Pickle.macroR
  given writer: Writer[structures.VersionedNotebookDocumentIdentifier] =
    upickle.default.macroW

private[lsp] trait structures_VersionedTextDocumentIdentifierCodec:
  import structures.*
  given reader: Reader[structures.VersionedTextDocumentIdentifier] =
    Pickle.macroR
  given writer: Writer[structures.VersionedTextDocumentIdentifier] =
    upickle.default.macroW
...
private[lsp] trait structures_WillSaveTextDocumentParamsCodec:
  ...
  given writer: Writer[structures.WillSaveTextDocumentParams] =
    upickle.default.macroW
...
private[lsp] trait structures_WindowClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.WindowClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkDoneProgressBeginCodec:
  ...
  given writer: Writer[structures.WorkDoneProgressBegin] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkDoneProgressCancelParamsCodec:
  ...
  given writer: Writer[structures.WorkDoneProgressCancelParams] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkDoneProgressCreateParamsCodec:
  ...
  given writer: Writer[structures.WorkDoneProgressCreateParams] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkDoneProgressOptionsCodec:
  ...
  given writer: Writer[structures.WorkDoneProgressOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkDoneProgressParamsCodec:
  ...
  given writer: Writer[structures.WorkDoneProgressParams] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkDoneProgressReportCodec:
  ...
  given writer: Writer[structures.WorkDoneProgressReport] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceClientCapabilitiesCodec:
  ...
  given writer: Writer[structures.WorkspaceClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceDiagnosticParamsCodec:
  ...
  given writer: Writer[structures.WorkspaceDiagnosticParams] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceDiagnosticReportCodec:
  ...
  given writer: Writer[structures.WorkspaceDiagnosticReport] =
    upickle.default.macroW

private[lsp] trait structures_WorkspaceDiagnosticReportPartialResultCodec:
  import structures.*
  given reader: Reader[structures.WorkspaceDiagnosticReportPartialResult] =
    Pickle.macroR
  given writer: Writer[structures.WorkspaceDiagnosticReportPartialResult] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceEditCodec:
  ...
  private given rd0: Reader[
    ...
    badMerge[
      ...
      structures.TextDocumentEdit.reader,
      structures.CreateFile.reader,
      structures.RenameFile.reader,
      structures.DeleteFile.reader
    )
  private given wt0: Writer[
    (structures.TextDocumentEdit | structures.CreateFile |
      structures.RenameFile | structures.DeleteFile)
    ...
    upickle.default
      ...
      .comap[
        ...
        (_v: @unchecked) match
          case v: structures.TextDocumentEdit =>
            writeJs[structures.TextDocumentEdit](v)
...
private[lsp] trait structures_WorkspaceEditClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.WorkspaceEditClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.WorkspaceEditClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceEditClientCapabilities_ChangeAnnotationSupportCodec:
  ...
  given reader: Reader[
    structures.WorkspaceEditClientCapabilities.ChangeAnnotationSupport
  ] = Pickle.macroR
  given writer: Writer[
    structures.WorkspaceEditClientCapabilities.ChangeAnnotationSupport
  ] = upickle.default.macroW
...
private[lsp] trait structures_WorkspaceFoldersChangeEventCodec:
  ...
  given writer: Writer[structures.WorkspaceFoldersChangeEvent] =
    upickle.default.macroW

private[lsp] trait structures_WorkspaceFoldersInitializeParamsCodec:
  import structures.*
  given reader: Reader[structures.WorkspaceFoldersInitializeParams] =
    Pickle.macroR
  given writer: Writer[structures.WorkspaceFoldersInitializeParams] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceFoldersServerCapabilitiesCodec:
  ...
  given reader: Reader[structures.WorkspaceFoldersServerCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.WorkspaceFoldersServerCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceFullDocumentDiagnosticReportCodec:
  import structures.*
  given reader: Reader[structures.WorkspaceFullDocumentDiagnosticReport] =
    Pickle.macroR
  given writer: Writer[structures.WorkspaceFullDocumentDiagnosticReport] =
    upickle.default.macroW

private[lsp] trait structures_WorkspaceSymbolCodec:
  import structures.*
  private given rd0: Reader[(structures.Location | WorkspaceSymbol.External)] =
    badMerge[(structures.Location | WorkspaceSymbol.External)](
      structures.Location.reader,
      WorkspaceSymbol.External.reader
    )
  private given wt0: Writer[(structures.Location | WorkspaceSymbol.External)] =
    upickle.default
      .writer[ujson.Value]
      .comap[(structures.Location | WorkspaceSymbol.External)] { _v =>
        (_v: @unchecked) match
          case v: structures.Location => writeJs[structures.Location](v)
          case v: WorkspaceSymbol.External =>
            writeJs[WorkspaceSymbol.External](v)
      }
...
private[lsp] trait structures_WorkspaceSymbol_ExternalCodec:
  ...
  given writer: Writer[structures.WorkspaceSymbol.External] =
    upickle.default.macroW

private[lsp] trait structures_WorkspaceSymbolClientCapabilitiesCodec:
  import structures.*
  given reader: Reader[structures.WorkspaceSymbolClientCapabilities] =
    Pickle.macroR
  given writer: Writer[structures.WorkspaceSymbolClientCapabilities] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceSymbolClientCapabilities_SymbolKindCodec:
  ...
  given reader
      : Reader[structures.WorkspaceSymbolClientCapabilities.SymbolKind] =
    Pickle.macroR
  given writer
      : Writer[structures.WorkspaceSymbolClientCapabilities.SymbolKind] =
    upickle.default.macroW

private[lsp] trait structures_WorkspaceSymbolClientCapabilities_TagSupportCodec:
  import structures.WorkspaceSymbolClientCapabilities.*
  given reader
      : Reader[structures.WorkspaceSymbolClientCapabilities.TagSupport] =
    Pickle.macroR
  given writer
      : Writer[structures.WorkspaceSymbolClientCapabilities.TagSupport] =
    upickle.default.macroW

private[lsp] trait structures_WorkspaceSymbolClientCapabilities_ResolveSupportCodec:
  import structures.WorkspaceSymbolClientCapabilities.*
  given reader
      : Reader[structures.WorkspaceSymbolClientCapabilities.ResolveSupport] =
    Pickle.macroR
  given writer
      : Writer[structures.WorkspaceSymbolClientCapabilities.ResolveSupport] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceSymbolOptionsCodec:
  ...
  given writer: Writer[structures.WorkspaceSymbolOptions] =
    upickle.default.macroW
...
private[lsp] trait structures_WorkspaceSymbolParamsCodec:
  ...
  given writer: Writer[structures.WorkspaceSymbolParams] =
    upickle.default.macroW

private[lsp] trait structures_WorkspaceSymbolRegistrationOptionsCodec:
  import structures.*
  given reader: Reader[structures.WorkspaceSymbolRegistrationOptions] =
    Pickle.macroR
  given writer: Writer[structures.WorkspaceSymbolRegistrationOptions] =
    upickle.default.macroW

private[lsp] trait structures_WorkspaceUnchangedDocumentDiagnosticReportCodec:
  import structures.*
  given reader: Reader[structures.WorkspaceUnchangedDocumentDiagnosticReport] =
    Pickle.macroR
  given writer: Writer[structures.WorkspaceUnchangedDocumentDiagnosticReport] =
    upickle.default.macroW
...
private[lsp] trait structures__InitializeParams_ClientInfoCodec:
  ...
  given writer: Writer[structures._InitializeParams.ClientInfo] =
    upickle.default.macroW
...
private[lsp] trait aliases_Declaration:
  ...
  given reader: Reader[Declaration] =
    badMerge[Declaration](
      structures.Location.reader,
      upickle.default.reader[Vector[structures.Location]]
    ).asInstanceOf[Reader[Declaration]]

  given writer: Writer[Declaration] =
    upickle.default
      .writer[ujson.Value]
      .comap[Declaration] { _v =>
        (_v: @unchecked) match
          case v: Vector[?] =>
            writeJs[Vector[structures.Location]](
              v.asInstanceOf[Vector[structures.Location]]
...
private[lsp] trait aliases_Definition:
  ...
  given reader: Reader[Definition] =
    badMerge[Definition](
      structures.Location.reader,
      upickle.default.reader[Vector[structures.Location]]
    ).asInstanceOf[Reader[Definition]]
...
private[lsp] trait aliases_DocumentFilter:
  ...
  given reader: Reader[DocumentFilter] =
    badMerge[DocumentFilter](
      aliases.TextDocumentFilter.reader,
      structures.NotebookCellTextDocumentFilter.reader
    ).asInstanceOf[Reader[DocumentFilter]]

  given writer: Writer[DocumentFilter] =
    upickle.default
      .writer[ujson.Value]
      .comap[DocumentFilter] { _v =>
        (_v: @unchecked) match
          case v: aliases.TextDocumentFilter =>
            writeJs[aliases.TextDocumentFilter](v)
          case v: structures.NotebookCellTextDocumentFilter =>
            writeJs[structures.NotebookCellTextDocumentFilter](v)
      }
...
private[lsp] trait aliases_InlineValue:
  ...
  given reader: Reader[InlineValue] =
    badMerge[InlineValue](
      structures.InlineValueText.reader,
      structures.InlineValueVariableLookup.reader,
      structures.InlineValueEvaluatableExpression.reader
    ).asInstanceOf[Reader[InlineValue]]

  given writer: Writer[InlineValue] =
    upickle.default
      .writer[ujson.Value]
      .comap[InlineValue] { _v =>
        (_v: @unchecked) match
          case v: structures.InlineValueText =>
            writeJs[structures.InlineValueText](v)
          case v: structures.InlineValueVariableLookup =>
            writeJs[structures.InlineValueVariableLookup](v)
          case v: structures.InlineValueEvaluatableExpression =>
            writeJs[structures.InlineValueEvaluatableExpression](v)
      }
...
private[lsp] trait aliases_MarkedString:
  ...
  given reader: Reader[MarkedString] =
    badMerge[MarkedString](stringCodec, MarkedString.MarkdownString.reader)
      .asInstanceOf[Reader[MarkedString]]

  given writer: Writer[MarkedString] =
    upickle.default
      .writer[ujson.Value]
      .comap[MarkedString] { _v =>
        (_v: @unchecked) match
          case v: String => writeJs[String](v)
          case v: MarkedString.MarkdownString =>
            writeJs[MarkedString.MarkdownString](v)
      }
...
private[lsp] trait aliases_MarkedString_MarkdownStringCodec:
  ...
  given writer: Writer[aliases.MarkedString.MarkdownString] =
    upickle.default.macroW

private[lsp] trait aliases_NotebookDocumentFilter:

  given reader: Reader[NotebookDocumentFilter] =
    badMerge[NotebookDocumentFilter](
      NotebookDocumentFilter.ByType.reader,
      NotebookDocumentFilter.ByScheme.reader,
      NotebookDocumentFilter.ByPattern.reader
    ).asInstanceOf[Reader[NotebookDocumentFilter]]

  given writer: Writer[NotebookDocumentFilter] =
    upickle.default
      .writer[ujson.Value]
      .comap[NotebookDocumentFilter] { _v =>
        (_v: @unchecked) match
          case v: NotebookDocumentFilter.ByType =>
            writeJs[NotebookDocumentFilter.ByType](v)
          case v: NotebookDocumentFilter.ByScheme =>
            writeJs[NotebookDocumentFilter.ByScheme](v)
          case v: NotebookDocumentFilter.ByPattern =>
            writeJs[NotebookDocumentFilter.ByPattern](v)
      }
...
private[lsp] trait aliases_NotebookDocumentFilter_ByTypeCodec:
  ...
  given writer: Writer[aliases.NotebookDocumentFilter.ByType] =
    upickle.default.macroW
...
private[lsp] trait aliases_NotebookDocumentFilter_BySchemeCodec:
  ...
  given writer: Writer[aliases.NotebookDocumentFilter.ByScheme] =
    upickle.default.macroW
...
private[lsp] trait aliases_NotebookDocumentFilter_ByPatternCodec:
  ...
  given writer: Writer[aliases.NotebookDocumentFilter.ByPattern] =
    upickle.default.macroW
...
private[lsp] trait aliases_PrepareRenameResult:
  ...
  given reader: Reader[PrepareRenameResult] =
    badMerge[PrepareRenameResult](
      structures.Range.reader,
      PrepareRenameResult.RangeAndPlaceholder.reader,
      PrepareRenameResult.DefaultBehavior.reader
    ).asInstanceOf[Reader[PrepareRenameResult]]

  given writer: Writer[PrepareRenameResult] =
    upickle.default
      .writer[ujson.Value]
      .comap[PrepareRenameResult] { _v =>
        (_v: @unchecked) match
          case v: structures.Range => writeJs[structures.Range](v)
          case v: PrepareRenameResult.RangeAndPlaceholder =>
            writeJs[PrepareRenameResult.RangeAndPlaceholder](v)
          case v: PrepareRenameResult.DefaultBehavior =>
            writeJs[PrepareRenameResult.DefaultBehavior](v)
      }
...
private[lsp] trait aliases_PrepareRenameResult_RangeAndPlaceholderCodec:
  ...
  given reader: Reader[aliases.PrepareRenameResult.RangeAndPlaceholder] =
    Pickle.macroR
  given writer: Writer[aliases.PrepareRenameResult.RangeAndPlaceholder] =
    upickle.default.macroW

private[lsp] trait aliases_PrepareRenameResult_DefaultBehaviorCodec:
  import aliases.PrepareRenameResult.*
  given reader: Reader[aliases.PrepareRenameResult.DefaultBehavior] =
    Pickle.macroR
  given writer: Writer[aliases.PrepareRenameResult.DefaultBehavior] =
    upickle.default.macroW
...
private[lsp] trait aliases_ProgressToken:
  ...
  given reader: Reader[ProgressToken] =
    badMerge[ProgressToken](intCodec, stringCodec)
      .asInstanceOf[Reader[ProgressToken]]

  given writer: Writer[ProgressToken] =
    upickle.default
      .writer[ujson.Value]
      .comap[ProgressToken] { _v =>
        (_v: @unchecked) match
          case v: Int    => writeJs[Int](v)
          case v: String => writeJs[String](v)
      }
...
private[lsp] trait aliases_TextDocumentContentChangeEvent:
  ...
  given reader: Reader[TextDocumentContentChangeEvent] =
    badMerge[TextDocumentContentChangeEvent](
      TextDocumentContentChangeEvent.Partial.reader,
      TextDocumentContentChangeEvent.Full.reader
    ).asInstanceOf[Reader[TextDocumentContentChangeEvent]]

  given writer: Writer[TextDocumentContentChangeEvent] =
    upickle.default
      .writer[ujson.Value]
      .comap[TextDocumentContentChangeEvent] { _v =>
        (_v: @unchecked) match
          case v: TextDocumentContentChangeEvent.Partial =>
            writeJs[TextDocumentContentChangeEvent.Partial](v)
          case v: TextDocumentContentChangeEvent.Full =>
            writeJs[TextDocumentContentChangeEvent.Full](v)
      }
...
private[lsp] trait aliases_TextDocumentContentChangeEvent_PartialCodec:
  ...
  given reader: Reader[aliases.TextDocumentContentChangeEvent.Partial] =
    Pickle.macroR
  given writer: Writer[aliases.TextDocumentContentChangeEvent.Partial] =
    upickle.default.macroW

private[lsp] trait aliases_TextDocumentContentChangeEvent_FullCodec:
  import aliases.TextDocumentContentChangeEvent.*
  given reader: Reader[aliases.TextDocumentContentChangeEvent.Full] =
    Pickle.macroR
  given writer: Writer[aliases.TextDocumentContentChangeEvent.Full] =
    upickle.default.macroW

private[lsp] trait aliases_TextDocumentFilter:

  given reader: Reader[TextDocumentFilter] =
    badMerge[TextDocumentFilter](
      TextDocumentFilter.ByLanguage.reader,
      TextDocumentFilter.ByScheme.reader,
      TextDocumentFilter.ByPattern.reader
    ).asInstanceOf[Reader[TextDocumentFilter]]

  given writer: Writer[TextDocumentFilter] =
    upickle.default
      .writer[ujson.Value]
      .comap[TextDocumentFilter] { _v =>
        (_v: @unchecked) match
          case v: TextDocumentFilter.ByLanguage =>
            writeJs[TextDocumentFilter.ByLanguage](v)
          case v: TextDocumentFilter.ByScheme =>
            writeJs[TextDocumentFilter.ByScheme](v)
          case v: TextDocumentFilter.ByPattern =>
            writeJs[TextDocumentFilter.ByPattern](v)
      }
...
private[lsp] trait aliases_TextDocumentFilter_ByLanguageCodec:
  ...
  given writer: Writer[aliases.TextDocumentFilter.ByLanguage] =
    upickle.default.macroW
...
private[lsp] trait aliases_TextDocumentFilter_BySchemeCodec:
  ...
  given writer: Writer[aliases.TextDocumentFilter.ByScheme] =
    upickle.default.macroW
