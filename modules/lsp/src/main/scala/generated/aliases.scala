...
object aliases:
  ...
  object Declaration extends codecs.aliases_Declaration:
    ...
    extension (v: Declaration)
      inline def value: (structures.Location | Vector[structures.Location]) = v
  ...
  object PrepareRenameResult extends codecs.aliases_PrepareRenameResult:
    ...
    extension (v: PrepareRenameResult)
      inline def value: (structures.Range | PrepareRenameResult.S0 |
        PrepareRenameResult.S1) = v
