...
object aliases: 
  ...
  object Declaration extends codecs.aliases_Declaration:
    ...
    extension (v: Declaration) inline def value: (structures.Location | Vector[structures.Location]) = v
  ...
  object DeclarationLink extends codecs.aliases_DeclarationLink:
    ...
    extension (v: DeclarationLink) inline def value: structures.LocationLink = v
  ...
  object Definition extends codecs.aliases_Definition:
    ...
    extension (v: Definition) inline def value: (structures.Location | Vector[structures.Location]) = v
  ...
  object DefinitionLink extends codecs.aliases_DefinitionLink:
    ...
    extension (v: DefinitionLink) inline def value: structures.LocationLink = v
  ...
  object DocumentDiagnosticReport extends codecs.aliases_DocumentDiagnosticReport:
    ...
    extension (v: DocumentDiagnosticReport) inline def value: (structures.RelatedFullDocumentDiagnosticReport | structures.RelatedUnchangedDocumentDiagnosticReport) = v
  ...
  object DocumentFilter extends codecs.aliases_DocumentFilter:
    ...
    extension (v: DocumentFilter) inline def value: (aliases.TextDocumentFilter | structures.NotebookCellTextDocumentFilter) = v
  ...
  object DocumentSelector extends codecs.aliases_DocumentSelector:
    ...
    extension (v: DocumentSelector) inline def value: Vector[aliases.DocumentFilter] = v
    
    given Typeable[DocumentSelector] with
      def unapply(s: Any): Option[s.type & DocumentSelector] = 
        s match
        case c: Vector[?] => Some(c.asInstanceOf[s.type & Vector[aliases.DocumentFilter]])
        case _ => Option.empty
  ...
  object GlobPattern extends codecs.aliases_GlobPattern:
    ...
    extension (v: GlobPattern) inline def value: (aliases.Pattern | structures.RelativePattern) = v
  ...
  object InlineValue extends codecs.aliases_InlineValue:
    ...
    extension (v: InlineValue) inline def value: (structures.InlineValueText | structures.InlineValueVariableLookup | structures.InlineValueEvaluatableExpression) = v
  ...
  object LSPObject extends codecs.aliases_LSPObject:
    ...
    given Typeable[LSPObject] with
      def unapply(s: Any): Option[s.type & LSPObject] = 
        s match
        case c: Map[String, io.circe.Json] => Some(c.asInstanceOf[s.type & Map[String, io.circe.Json]])
        case _ => Option.empty
  ...
  object NotebookDocumentFilter extends codecs.aliases_NotebookDocumentFilter:
    ...
    extension (v: NotebookDocumentFilter) inline def value: (NotebookDocumentFilter.S0 | NotebookDocumentFilter.S1 | NotebookDocumentFilter.S2) = v
  ...
  object PrepareRenameResult extends codecs.aliases_PrepareRenameResult:
    ...
    extension (v: PrepareRenameResult) inline def value: (structures.Range | PrepareRenameResult.S0 | PrepareRenameResult.S1) = v
  ...
  object TextDocumentContentChangeEvent extends codecs.aliases_TextDocumentContentChangeEvent:
    ...
    extension (v: TextDocumentContentChangeEvent) inline def value: (TextDocumentContentChangeEvent.S0 | TextDocumentContentChangeEvent.S1) = v
  ...
  object TextDocumentFilter extends codecs.aliases_TextDocumentFilter:
    ...
    extension (v: TextDocumentFilter) inline def value: (TextDocumentFilter.S0 | TextDocumentFilter.S1 | TextDocumentFilter.S2) = v
  ...
  object WorkspaceDocumentDiagnosticReport extends codecs.aliases_WorkspaceDocumentDiagnosticReport:
    ...
    extension (v: WorkspaceDocumentDiagnosticReport) inline def value: (structures.WorkspaceFullDocumentDiagnosticReport | structures.WorkspaceUnchangedDocumentDiagnosticReport) = v
